...
<head>
  ...
  <!-- <title>Print custom stickers</title> -->
...
<body style="background: #f1f1f1;">
  <div class="container">
    ...
    <p>Create you own custom design with our online design tool. Remix any of our templates or start from a blank slate.</p>
    ...
    <div class="row">
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="box box-shape horizontal" data-title-if-item-not-available="" id="box-shape">
                ...
                <a href="javascript:void(0);" id="rect-item" class="shape item " data-sheet-type="single" data-template-name="rect">
              ...
              <div class="box-container-quantity-and-prices" id="box-quantity">
                ...
                <div class="box">
                  <div data-text-pcs=" pcs" id="getpcs">
                    <a href="javascript:void(0);" class="item quantity" data-quantity="111" data-price="$26" data-laser-price="" data-laser-save="">
            ...
            <div class="col-sm-5 col-md-4">
              ...
              <div id="summary">
                ...
                <button type="button" id="btnNext" class="btn btn-xl btn-primary btn-block" data-loading-text="Loading..." style="margin-top: 0;">
     ...
     -->
      ...
      <br><br><br>
      <h5 style="text-align: center;">© Sticker Customizer</h5>
