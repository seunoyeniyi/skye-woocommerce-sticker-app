...
<head>
	...
	<script src="https://connect.facebook.net/signals/config/245509430055321?v=2.9.57&amp;r=stable" async=""></script>
	...
	<title>Checkout - StickerApp</title>
	...
	<link rel="icon" type="image/x-icon" href="https://d6ce0no7ktiq.cloudfront.net/images/web/favicon.ico">
	<link rel="canonical" href="https://stickerapp.com/checkout">
	...
	<style type="text/css" media="all">
		...
		body.checkout #summary .alert {
			margin: 15px 0 0
		}

		#discount-message .alert,
		#giftcard-message .alert {
			margin: 10px 0 0
		}

		#addresses .box,
		#billing-address-box .box {
			padding-bottom: 0
		}
		...
		body.checkout .has-error .control-label {
			color: #a94442
		}
		...
		.icon.stripe {
			background-image: url(/static/images/web/sprites/stickerapp.png);
		...
		.icon.giropay {
			background-image: url(https://d6ce0no7ktiq.cloudfront.net/images/web/checkout/giropay.png);
		...
		.icon.ideal {
			background-image: url(https://d6ce0no7ktiq.cloudfront.net/images/web/checkout/ideal.png) !important;
			background-position: 0
		}
		...
		.icon.discover {
			background-position: -22px -450px !important
		}

		#payment-methods .icon.ideal {
			width: 30px
		}
		...
		.options label .icon.klarna,
		.options label .icon.paypal,
		.options label .icon.visa,
		.options label img {
			float: right
		}
		...
		body.checkout .item img.giftcard {
			max-height: 60px
		}

		body.checkout .item img.sticker-pack {
			max-height: 100px
		}

		body.checkout .row.item .title {
			position: absolute
		}

		body.checkout .row.item>div {
			display: table
		}

		body.checkout .item .preview svg,
		body.checkout .row.item>div {
			height: 100px
		}
		...
		body.checkout .item a.edit-btn {
			right: 55px
		}

		body.checkout .item a.item-btn:hover {
			text-decoration: none
		}

		body.checkout .row.item .description {
			line-height: 16px
		}

		body.checkout .row.item .note {
			color: #666
		}

		#klarna-confirm-wrapper td {
			border-top: none
		}

		#klarna-confirm-wrapper .table {
			margin-bottom: 0;
			width: 100%
		}
		...
		#invoice-alternatives .has-feedback .form-control-feedback {
			top: 0
		}
		...
		#invoice-pdf-email-container {
			padding: 5px
		}

		#invoice-pdf-email-container,
		#invoice-pdf-email-container #invoice-checkbox-container,
		#invoice-pdf-email-container #invoice-input-container,
		#invoice-pdf-email-container label {
			background: #e8e8e8
		}

		#invoice-pdf-email-container .active {
			font-weight: 400
		}

		#invoice-pdf-email-checkbox {
			margin-top: 5px
		}
		...
		#summary .summary-item.summary-total {
			color: #333;
			font-size: 18px;
			font-weight: 700
		}
		...
		.customer-type .option label input {
			margin-right: .5rem
		}

		body.checkout .success-info hr {
			margin: 5px 0
		}

		.payment-adyen .form-control-feedback {
			top: -2px
		}
		...
		@media (max-width:767px) {
			...
			body.checkout .item .buttons {
				right: 30px
			}

			.options .price-tag.sm {
				margin-left: 6px
			}

			body.checkout .item>div {
				padding-left: 5px;
				padding-right: 5px
			}

			body.checkout .preview a {
				font-size: 10px
			}
			...
			body.checkout .item .piece-price,
			body.checkout .item .total {
				font-size: 12px
			}

			body.checkout .item a.remove-btn {
				right: 5px
			}
		...
		#matching-billing-address-holder,
		#matching-shipping-address-holder {
			background-color: #fff;
			padding: 7px 5px 15px
		}

		#matching-billing-address-holder h6,
		#matching-shipping-address-holder h6 {
			margin: 0 0 5px
		}

		#matching-billing-address-holder em,
		#matching-billing-address-holder span,
		#matching-billing-address-holder strong,
		#matching-shipping-address-holder em,
		#matching-shipping-address-holder span,
		#matching-shipping-address-holder strong {
			font-size: 90%
		}

		#matching-billing-address-holder .btn-link,
		#matching-shipping-address-holder .btn-link {
			padding: 5px 0
		}
		...
		@media (max-width:767px) {
			body.checkout .page-header .container {
				align-items: center;
				display: flex;
				flex-direction: column
			}
		...
		body.checkout .row.item .duplicate-btn,
		body.checkout .row.item .edit-btn {
			position: unset
		}

		body.checkout .stickerapp .row.item {
			padding: 20px 5px 0;
			position: relative
		}
		...
		@media (max-width:767px) {
			...
			body.checkout .stickerapp .row.item.single:not(:first-child) {
				border-top: 1px dashed #dadbd6
			}

			body.checkout .stickerapp .row.item .description {
				height: auto;
				padding: 0;
				text-align: center
			}

			body.checkout .stickerapp .row.item div[class^=col] .title {
				position: unset
			}

			body.checkout .stickerapp .row.item div[class^=col].ppc,
			body.checkout .stickerapp .row.item div[class^=col].quantity,
			body.checkout .stickerapp .row.item div[class^=col].total {
				align-items: center;
				display: flex;
				flex-direction: column;
				height: auto;
			...
			body.checkout .stickerapp .row.item div[class^=col].quantity p {
				margin-top: 4px
			}

			body.checkout .stickerapp .row.item a.remove-btn {
				margin-top: 0;
				top: 10px
			}
		}

		body.checkout .stickerapp .preview svg {
			height: 100px
		}

		body.checkout .stickerapp .preview svg.double-preview {
			max-width: 50%;
			width: auto
		}

		body.checkout .stickerapp .sheet-preview {
			justify-content: center
		}

		body.checkout .caseapp .row.item .btn-xs {
			font-size: 11px !important;
			padding: 9px 14px 7px
		}

		body.checkout .caseapp .row.item .remove-btn span {
			top: 2.5px !important
		}

		@media (max-width:768px) {
			body.checkout .small-btn-wrapper {
				height: 0 !important
			}
		}

		body.checkout #access-points {
			border-bottom: 1px solid #ddd;
			margin: 0;
			padding: 0
		}

		body.checkout #access-points .alert {
			border-radius: 0;
			margin-bottom: 0
		}

		body.checkout #access-points .access-point {
			align-items: center;
			cursor: pointer;
			display: flex;
			margin-bottom: 0;
		...
		body.checkout #access-points .access-point.active,
		body.checkout #access-points .access-point:hover {
			background-color: #ddd
		}

		body.checkout #access-points .access-point i.glyphicon.glyphicon-time {
			color: #999;
			float: right
		}

		body.checkout #access-points .location-address {
			display: block;
			font-size: 10px;
			font-weight: 400
		}

		body.checkout #access-points .location-distance {
			font-size: 10px;
			padding-left: 5px
		}

		body.checkout #access-points .location-distance i {
			color: #4683da
		}

		body.checkout #access-points .location-header {
			font-size: 14px;
			font-weight: 700
		}

		body.checkout #access-points .access-point-hours-item {
			font-size: 14px;
			list-style-type: none
		}

		body.checkout #access-points #ups-error span.glyphicon {
			height: 0
		}
		...
		body.checkout .loader div:first-child {
			animation: lds-ellipsis1 .6s infinite;
			left: 8px
		}

		body.checkout .loader div:nth-child(2) {
			animation: lds-ellipsis2 .6s infinite;
			left: 8px
		}

		body.checkout .loader div:nth-child(3) {
			animation: lds-ellipsis2 .6s infinite;
			left: 32px
		}

		body.checkout .loader div:nth-child(4) {
		...
		body.checkout .options label input {
			box-shadow: none
		}
	</style>
	...
	<script src="https://bat.bing.com/p/action/26345997.js" type="text/javascript" async="" data-ueto="ueto_c32309922f"></script>
	<script src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/939789830/?random=1647414811308&amp;cv=9&amp;fst=1647414811308&amp;num=1&amp;bg=ffffff&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;u_h=768&amp;u_w=1366&amp;u_ah=728&amp;u_aw=1366&amp;u_cd=24&amp;u_his=6&amp;u_tz=60&amp;u_java=false&amp;u_nplug=0&amp;u_nmime=0&amp;gtm=2wg3e0&amp;sendb=1&amp;ig=0&amp;frm=0&amp;url=https%3A%2F%2Fstickerapp.com%2Fcheckout&amp;ref=https%3A%2F%2Fstickerapp.com%2Feditor%2Fedit%2Fnew%2Fsingle%2Frect%2F0%2F200%2F76%2F76%2Fglossy_coated&amp;tiba=Checkout%20-%20StickerApp&amp;hn=www.google.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script>
</head>
...
<body class="checkout">
	<div class="main-wrapper">
		...
		<div id="wrapper">
			...
			<div class="navbar stickerapp-nav" role="navigation" style="display:none">
				...
				<div class="f-row nav-row f-align-items-center hidden-xs hidden-sm">
					<ul class="nav navbar-nav navbar-left primary-nav f-row f-space-around ">
						<li>
							<a href="https://stickerapp.com/custom-stickers">Custom stickers</a>
						</li>
			...
			<div class="dark-bg page-header" style="">
				<div class="container" data-pixel-event-id="384a58281bda25" data-gtm-checkout-page="{&quot;content_ids&quot;:[&quot;clear_custom_labels&quot;,&quot;glossy_coated&quot;],&quot;currency&quot;:&quot;USD&quot;,&quot;value&quot;:355,&quot;content_name&quot;:&quot;checkout&quot;,&quot;content_type&quot;:&quot;product&quot;}">
					<h1>Checkout</h1>

					<a href="https://stickerapp.com/" class="btn btn-grey btn-right">
						Continue shopping <span class="glyphicon glyphicon-menu-right"></span>
					</a>
				</div>
			</div>

			<div class="container margin-top stickerapp">
				...
				<div id="sheets-container">
					...
					for ($i = 0; $i < sizeof($_SESSION['rect']); $i++) {
						...
						echo '</div>';
						echo    '<a href="#!" data-id="' . $i . '" title="Remove" class="item-btn  btn removeSession">';
				...
				<hr>
				<div class="row">
					<div id="address-wrapper" class="col-sm-7" data-nexus-regions="AK,AZ,AR,CA,CO,CT,DC,FL,GA,HI,ID,IL,IN,IA,KS,KY,LA,ME,MD,MA,MI,MN,NE,NV,NJ,NM,NY,NC,OH,OK,PA,RI,SC,SD,TN,TX,UT,VT,VA,WA,WV,WI,WY" data-validation-header="Is this your address?" data-validation-use="Use this address" data-validation-close="Close" data-validation-error="We couldn't find a matching address. Double-check the address details or click Close to continue.">
						<div class="row">
							<div class="col-xs-6">
								<h4 class="margin-top-xs margin-bottom-xs">Shipping and billing</h4>
							</div>
						...
						<div id="addresses">
							<div class="customer-type">
								<div class="option">
									<label>
										<input id="is-business" type="checkbox" name="orders_meta[billing][is_company]">
										Business </label>
								</div>
							</div>

							<div id="billing-form" class="box">
								<div class="row" id="company-fields" style="display:none">
									<div class="col-sm-6 col-lg-6">
										<div class="form-group">
											<label for="company_name" class="control-label">Company name</label>
											<input type="text" name="orders_meta[billing][name]" id="company_name" required="" maxlength="35" class="form-control" value="">
										</div>
									</div>
									<div class="col-sm-6 col-lg-6" id="vat_number_row">

										<div class="form-group">
											<label for="orders_meta[billing][company_vat_number]" class="control-label">
												VAT-number
												<span id="vat-tag" class="label" data-success="Valid" data-fail="Not valid" data-loading="Verifying..." data-database-down="Could not validate" style="display: none;">
												</span>
											</label>
											<input type="text" name="orders_meta[billing][company_vat_number]" id="vat_number" class="form-control" value="" data-countrycode="">
											<input id="validate-vat-nonce" type="hidden" name="vat_nonce" value="66214ae00e7692f32dc415d483ff01c1fc5aba8fb1089a4cafc3e12602365e5dc7d508938f1f380f1ea76fd4132bcee2558e200993ba3f97061a68dbcb899f2c" readonly="">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-6 col-lg-6">
										<div class="form-group">
											...
											<input type="text" name="orders_meta[billing][first_name]" id="firstname" class="form-control" required="" value="">
										</div>
									</div>
									<div class="col-sm-6 col-lg-6">
										<div class="form-group">
											<label for="surname" class="control-label">Last Name</label>
											<input type="text" name="orders_meta[billing][surname]" id="surname" class="form-control" required="" value="">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-12 col-lg-12">
										<div class="form-group">
											...
											<input type="email" name="orders_meta[billing][email]" id="email" class="form-control" required="" value="">
										</div>
									</div>
								</div>
									...
									<div class="col-sm-6 col-lg-6">
										<div class="">
											<div class="form-group">
												...
												<input placeholder=" " type="text" name="orders_meta[billing][address]" id="address" class="form-control" required="" value="" maxlength="35" data-alphabet-only="true" data-toggle="tooltip" data-trigger="manual" data-placement="top" title="" data-field="address" data-original-title="UPS does not ship to P.O. boxes. Please provide street address.">
											</div>
										</div>
									</div>
									<div class="col-sm-6 col-lg-6">
										<div class="form-group">
											...
											<input placeholder=" " type="text" name="orders_meta[billing][address2]" id="address2" class="form-control" maxlength="35" value="" data-alphabet-only="true" title="UPS does not ship to P.O. boxes. Please provide street address." data-field="address">
										</div>
									</div>
								</div>
								<div class="row">
										...
										<div class="row">
											<div class="col-xs-6 col-sm-12 col-md-6">
												<div class="form-group">
													...
													<input type="text" name="orders_meta[billing][zip]" id="zip" class="form-control" required="" value="">
												</div>
											</div>
											<div class="col-xs-6 col-sm-12 col-md-6">
												<div class="form-group">
													<label for="city" class="control-label">City</label>
													<input type="text" name="orders_meta[billing][city]" id="city" class="form-control" required="" value="" data-alphabet-only="true">
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-xs-6 col">
												<div class="form-group state-wrapper">
													<label for="orders_meta_billing_county_" class="control-label">State</label>

													<select type="" name="orders_meta[billing][county]" id="orders_meta_billing_county_" class="form-control form-input-element stateselect" autocomplete="off" data-countryel="#country" data-value="" required="">
														<option value="">-</option>
											...
											<div class="col-xs-6 col">
												<div class="form-group">
													...
													<select name="orders_meta[billing][country_code]" id="country" class="form-control" required="">
														<option value="af">
															Afghanistan </option>
														<option value="ax">
								...
								<div class="row">
									<div id="phone-wrapper" class="col-sm-6 nodisplay" style="display: block;">
										<div class="form-group">
											<label for="phone" class="control-label">Phone</label>
											<input type="phone" name="orders_meta[billing][phone]" id="phone" class="form-control" required="" value="">
										</div>
									</div>
								</div>
							...
							<div class="row margin-top-xs" style="margin-left:0;">
								<div class="col-sm-12">
									<label for="other-shipping-address" class="control-label">
										<input type="checkbox" name="other-shipping-address" id="other-shipping-address" class="margin-bottom-xs">
										Use a different shipping address </label>
								</div>
							</div>

							<label class="hidden" for="ups_location_id">
								<input required="" name="orders_meta[ups_location_id]" id="ups_location_id" type="text" class="form-control">
							</label>
							<div id="shipping-address-box" class="margin-bottom nodisplay" style="display: none;">
								<div class="box">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="shipping-name" class="control-label">Name or company</label>
												<input type="text" name="orders_meta[shipping][name]" class="form-control" id="shipping-name" maxlength="35" value="" required="">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label for="shipping-att-name" class="control-label">Attention name</label>
												<input type="text" name="orders_meta[shipping][att_name]" class="form-control" id="shipping-att-name" maxlength="35" value="">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="shipping-address" class="control-label">Address line 1</label>
												<input placeholder=" " type="text" name="orders_meta[shipping][address]" maxlength="35" class="form-control" id="shipping-address" value="" data-alphanumeric="true" data-toggle="tooltip" data-trigger="manual" data-placement="top" title="" data-field="address" required="" data-original-title="UPS does not ship to P.O. boxes. Please provide street address.">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label for="shipping-address2" class="control-label">Address line 2</label>
												<input placeholder=" " type="text" name="orders_meta[shipping][address2]" maxlength="35" class="form-control" id="shipping-address2" value="" title="UPS does not ship to P.O. boxes. Please provide street address." data-field="address">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-6">
											<div class="row">
												<div class="col-xs-6">
													<div class="form-group">
														<label for="shipping-zip" class="control-label">Zip Code</label>
														<input type="text" name="orders_meta[shipping][zip]" class="form-control" id="shipping-zip" value="" required="">
													</div>
												</div>
												<div class="col-xs-6">
													<div class="form-group">
														<label for="shipping-city" class="control-label">City</label>
														<input type="text" name="orders_meta[shipping][city]" class="form-control" id="shipping-city" value="" required="">
													</div>
												</div>
											</div>
											<div id="phone-wrapper-shipping" class="nodisplay" style="display: none;">
												<div class="form-group">
													<label for="phone" class="control-label">Phone</label>
													<input type="phone" name="orders_meta[shipping][phone]" id="phone-shipping" class="form-control" required="" value="">
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="row">
												<div class="col">
													<div class="form-group nodisplay state-wrapper">
														<label for="orders_meta_shipping_county_" class="control-label">State</label>

														<select type="" name="orders_meta[shipping][county]" id="orders_meta_shipping_county_" class="form-control form-input-element stateselect" autocomplete="off" data-countryel="#shipping-country" data-value="">
															<option value="">-</option>
														</select>
													</div>
												</div>
												<div class="col col-xs-12">
													<div class="form-group">
														...
														<select value="" name="orders_meta[shipping][country_code]" class="form-control shipping-country" id="shipping-country" required="">
															<option value=""></option>
															<option value="af">
																Afghanistan </option>
															<option value="ax">
							...
							</div> <input id="validate-address-nonce" type="hidden" name="address_nonce" value="801146c62bc75268315d2ef79a5f37e4ce513ac4c29609876644043f18433aefa00567ed36b47544b324273e63b6e766f2b0b2e29100aa348bb902fac0223a4c" readonly="">
						</div>


						<div id="a-note" class="col-sm-12">
							<div class="form-group">
								<label for="have-note" class="control-label">
									<input type="checkbox" name="have-note" id="have-note">
									Comment </label>
								<textarea id="note" name="note" class="form-control nodisplay" rows="1"></textarea>
							</div>
						</div>
					</div>
					<div class="col-sm-5">
						<div id="payments">
							<h4 class="margin-top-xs margin-bottom-xs">Payment method</h4>
							<div id="payment-methods" class="box margin-bottom-sm options two">



								<!-- Card payments -->
								<label id="payment-adyen" class="active">
									<input type="radio" name="payment_method" value="adyen">
									Credit card <i class="icon visa"></i>
								</label>
								<!-- End of card payments -->



								<label id="payment-paypal">
							...
							<div id="invoice-alternatives" style="display: none;">
								<h5 class="margin-top-xs margin-bottom-xs">Invoice method</h5>
								<div class="box margin-bottom-sm options">


									<label for="pdf-invoice">
										<input checked="" type="radio" id="pdf-invoice" value="pdf" name="orders_meta[invoice_method]">
										PDF
										<small id="invoice-receipt-email-paragraph" class="pull-right"></small>
									</label>

									<div id="invoice-pdf-email-container">
										<div id="invoice-checkbox-container">
											<label class="control-label" for="invoice-pdf-email-checkbox">
												<input type="checkbox" class="form-check-input" id="invoice-pdf-email-checkbox">
												Send invoice to other email address </label>
										</div>

										<div id="invoice-input-container" class="form-group">
											<input required="" name="orders_meta[pdf_email]" id="invoice-pdf-email" type="email" class="form-control">
										</div>
									</div>
								</div>
							</div>
						...
						<div>
							<h4 class="margin-bottom-xs margin-top-xs">Estimated delivery date</h4>
							<div id="shipping-types" class="box options margin-bottom-sm">
								<label id="shipping-normal2" style="display: none;">
									<input type="radio" name="shipping_type" value="normal2" checked="">
									<span class="shipping-title">Free</span>
								...
								<label id="shipping-normal" style="display: none;">
									<input type="radio" name="shipping_type" value="normal">
									<span class="shipping-title">Standard</span>
									<small class="days"></small>
									<div class="price-tag sm">
										<div class="price"></div>
									</div>
								...
								<label id="shipping-fast" class="active">
									<input type="radio" name="shipping_type" value="fast" service="upse" phone-required="1">
									Fast <small class="days">March 23-24</small>
									<div class="price-tag sm" style="display: none;">
										<div class="price"></div>
									</div>
									<img src="https://d6ce0no7ktiq.cloudfront.net/images/web/checkout/ups.png" height="26">
								</label>
								<label id="shipping-express">
									<input type="radio" name="shipping_type" value="express" service="upse" phone-required="1">
									Express <small class="days">March 21</small>
									<div class="price-tag sm">
										<div class="price">$107</div>
									</div>
									<img src="https://d6ce0no7ktiq.cloudfront.net/images/web/checkout/ups.png" height="26">
								</label>
								<label id="shipping-email" style="display: none;">
									<input type="radio" name="shipping_type" value="email">
									Email <small class="days">Sent to your email after payment</small>
									<img src="" style="margin-top:3px;margin-bottom:3px;" height="20">
								</label>
							</div>
						</div>
						<div id="address-wrapper-sm"></div>

						<div class="box margin-bottom-xs margin-top">
							<div id="summary">
								<div class="row summary-item summary-amount">
									<div class="col-xs-6 summary-title">Amount</div>
									<div class="col-xs-6 summary-price"> $355</div>
								</div>
								<div class="row summary-item summary-shipping">
									<div class="col-xs-6 summary-title">Shipping</div>
									<div class="col-xs-6 summary-price"> $0</div>
								</div>
								<div class="row summary-item summary-total">
									<div class="col-xs-6 summary-title">Total amount <span style="font-weight: normal; font-size: 80%;" class="summary-item">(USD)</span></div>
									<div class="col-xs-6 summary-price"> $355</div>
								</div>
							</div>

							<div class="customs-warning hidden">
							</div>

							<div id="taxjar-error" class="well-sm bg-danger text-danger margin-top-sm margin-bottom-sm hidden">
							</div>



							<div id="card-info" class="row margin-top-sm" style="display: block;">
								<div class="col-lg-6">
									<div class="form-group">
										<label for="card_number" class="control-label">Card number</label>
										<input type="tel" id="card_number" class="form-control" required="" autocomplete="cc-number" maxlength="19" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57">
									</div>
								</div>

								<div class="col-lg-6">
									<div class="row">
										<div class="col-xs-7 cvc-col">
											<div class="form-group">
												<label for="exp_month" class="control-label">Expiration date</label>
												<div class="input-group" data-error-message="Expiry Date Invalid">
													<input type="tel" pattern="\d*" class="form-control" id="exp_month" maxlength="2" required="" placeholder="MM" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57">
													<div class="input-group-addon" style="border-right: none; border-left: none; background-color: inherit; padding: 6px 5px;">/</div>
													<input type="tel" pattern="\d*" class="form-control" id="exp_year" maxlength="2" required="" placeholder="YY" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57">
												</div>
											</div>
										</div>
										<div class="col-xs-5">
											<div class="form-group">
												<label for="cvc_code" class="control-label">CVC<a href="#!" class="" data-toggle="modal" data-target="#cvc-modal">?</a>
												</label>
												<input type="tel" pattern="\d*" id="cvc_code" class="form-control" maxlength="4" required="" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57">
											</div>
										</div>
									</div>
								</div>
							...
							<div id="cvc-modal" class="modal">

								<div class="modal-dialog modal-sm">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal">×</button>
											<h4 class="modal-title">CVC code?</h4>
										</div>
										<div class="modal-body">

											The control digits (also called Control Verification Code or CVC) are usually found on the back of the payment card. <img alt="Creditcard CVC" class="img-responsive margin-top-sm" src="https://d6ce0no7ktiq.cloudfront.net/images/web/checkout/creditcard_cvc.png">
										</div>
							...
							<script type="text/javascript" src="https://live.adyen.com/hpp/cse/js/2614969103961521.shtml"></script>
							<form id="adyen-encrypted-form" class="hidden">
								<input type="text" id="cn" size="20" data-encrypted-name="number" value="">
								<input type="text" id="hn" size="20" data-encrypted-name="holderName" value="">
								<input type="text" id="em" size="2" data-encrypted-name="expiryMonth" value="">
								<input type="text" id="ey" size="4" data-encrypted-name="expiryYear" value="">
								<input type="text" id="cv" size="4" data-encrypted-name="cvc" value="">
								<input type="hidden" value="2022-03-16T08:13:13+01:00" data-encrypted-name="generationtime">
								<input id="adyenbtn" type="submit" value="Pay">
							</form>
							<input class="hidden" id="encryptedCardInfo" value="">

							<form method="POST" action="" id="3dform" class="hidden">
								<input type="hidden" id="StLand" name="StLand" value="">
								<input type="hidden" id="PaReq" name="PaReq" value="">
								<input type="hidden" id="MD" name="MD" value="">
								<input type="hidden" id="TermUrl" name="TermUrl" value="https://stickerapp.com/checkout/adyen_3ds_auth">
							</form>




							<div id="summary-submit-wrapper">
								<div id="checkout-error" class="alert alert-danger nodisplay margin-top-xs margin-bottom-xs" style="display: none;"></div>
								<hr>
								<small id="approve_terms">By continuing I accept the <a href="https://stickerapp.com/conditions">Terms of use</a>.</small>

								<button type="button" id="checkout-submit" class="btn btn-xl btn-primary btn-block margin-top-sm" data-loading-text="Loading...">
									Confirm and pay <span class="glyphicon glyphicon-menu-right"></span>
								</button>
							</div>
						</div>

						<div id="coupon-code-wrapper" class="col-sm-12 margin-top-sm">
							<div class="form-group">
								<label for="have-discount" class="control-label">
									<input type="checkbox" name="have-discount" id="have-discount">
									Coupon code </label>

								<div id="discount-wrapper" class="nodisplay">
									<div class="input-group">
										<input type="text" id="discount-code" class="form-control input-sm" value="" placeholder="Coupon code: XXXXXX">
										<div class="input-group-btn">
											<a href="#!" id="discount-code-btn" class="btn btn-success btn-sm" data-loading-text="Loading...">
												Redeem </a>
										</div>
									</div>
						...
						<!-- For giftcards -->
						<div id="giftcard-code-wrapper" class="col-sm-12 margin-bottom">
							<div class="form-group">
								<label for="have-giftcard" class="control-label strong bold">
									<input type="checkbox" name="have-giftcard" id="have-giftcard">
									Gift Card </label>

								<div id="giftcard-wrapper" class="nodisplay">
									<div class="input-group">
										<input type="text" id="giftcard-code" class="form-control input-sm" value="" placeholder="Gift Card: STAPP-XXXXXXXX-XXXX">
										<div class="input-group-btn">
											<a href="#!" id="giftcard-code-btn" class="btn btn-success btn-sm" data-loading-text="Loading...">
												Redeem </a>
										</div>
									</div>
			...
			<form method="post" action="https://live.adyen.com/hpp/skipDetails.shtml" id="adyenForm" name="adyenForm" target="_parent">
				...
				<input type="hidden" name="shopperLocale" value="">
				...
				<input type="hidden" name="skinCode" value="">
...
<div class="country-site-selector-wrapper">
            ...
            <div class="text-center">
                <div class="country-site-selector-dropdown">
                    <div class="country-site-selector-dropdown-content">
	...
	<!-- SCRIPTS -->
	<script src="../editor/edit/new/single/circle/stickerapp.js"></script>
	<!-- <script src="https://d6ce0no7ktiq.cloudfront.net/build/5.7.89/checkout.js"></script> -->
	<script src="../editor/edit/new/single/circle/editor.js"></script>
