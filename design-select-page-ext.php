...
<style type="text/css" media="all">
    ...
    *,
    ...
    @media screen and (-webkit-min-device-pixel-ratio:0) {
      ...
      .input-group-sm>.input-group-btn>input.btnxxxxxxx[type=date],
      .input-group-sm>.input-group-btn>input.btnxxxxxxx[type=datetime-local],
      .input-group-sm>.input-group-btn>input.btnxxxxxxx[type=month],
      .input-group-sm>.input-group-btn>input.btnxxxxxxx[type=time],
      ...
      .input-group-lg>.input-group-btn>input.btnxxxxxxx[type=date],
      .input-group-lg>.input-group-btn>input.btnxxxxxxx[type=datetime-local],
      .input-group-lg>.input-group-btn>input.btnxxxxxxx[type=month],
      .input-group-lg>.input-group-btn>input.btnxxxxxxx[type=time],
    ...
    .input-group-lg>.input-group-btn>.form-control-static.btnxxxxxxx,
    .input-group-sm>.form-control-static.form-control,
    .input-group-sm>.form-control-static.input-group-addon,
    .input-group-sm>.input-group-btn>.form-control-static.btnxxxxxxx {
      padding-left: 0;
      padding-right: 0
    }
    ...
    .input-group-sm>.input-group-btn>.btnxxxxxxx,
    .input-sm {
      border-radius: 3px;
      font-size: 14px;
      height: 33px;
    ...
    .input-group-sm>.input-group-btn>select.btnxxxxxxx,
    ...
    .input-group-sm>.input-group-btn>select.btnxxxxxxx[multiple],
    .input-group-sm>.input-group-btn>textarea.btnxxxxxxx,
    ...
    .input-group-lg>.input-group-btn>.btnxxxxxxx,
    .input-lg {
      border-radius: 6px;
      font-size: 20px;
      height: 49px;
    ...
    .input-group-lg>.input-group-btn>select.btnxxxxxxx,
    ...
    .input-group-lg>.input-group-btn>select.btnxxxxxxx[multiple],
    .input-group-lg>.input-group-btn>textarea.btnxxxxxxx,
    ...
    .input-group-lg>.input-group-btn>.btnxxxxxxx+.form-control-feedback,
    ...
    .input-group-sm>.input-group-btn>.btnxxxxxxx+.form-control-feedback,
    ...
    a.btnxxxxxxx.disabled,
    a.cta.disabled,
    fieldset[disabled] a.btnxxxxxxx {
      pointer-events: none
    }
    ...
    .btnxxxxxxx-default.active,
    .btnxxxxxxx-default:active,
    .btnxxxxxxx-default:hover,
    .open>.btnxxxxxxx-default.dropdown-toggle {
      background-color: #141313;
      border-color: #b7bfc5;
      color: #ffdb00
    }

    .btnxxxxxxx-default.active.focus,
    .btnxxxxxxx-default.active:focus,
    .btnxxxxxxx-default.active:hover,
    .btnxxxxxxx-default:active.focus,
    .btnxxxxxxx-default:active:focus,
    .btnxxxxxxx-default:active:hover,
    .open>.btnxxxxxxx-default.dropdown-toggle.focus,
    .open>.btnxxxxxxx-default.dropdown-toggle:focus,
    .open>.btnxxxxxxx-default.dropdown-toggle:hover {
    ...
    .btnxxxxxxx-default.disabled.focus,
    .btnxxxxxxx-default.disabled:focus,
    .btnxxxxxxx-default.disabled:hover,
    .btnxxxxxxx-default[disabled].focus,
    .btnxxxxxxx-default[disabled]:focus,
    .btnxxxxxxx-default[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-default.focus,
    fieldset[disabled] .btnxxxxxxx-default:focus,
    fieldset[disabled] .btnxxxxxxx-default:hover {
      background-color: #2d2d2d;
      border-color: #d9dde0
    }

    .btnxxxxxxx-default .badge {
    ...
    .btnxxxxxxx-primary.active,
    .btnxxxxxxx-primary:active,
    .btnxxxxxxx-primary:hover,
    .open>.btnxxxxxxx-primary.dropdown-toggle {
      background-color: #ccaf00;
      border-color: #c2a600;
      color: #040404
    }

    .btnxxxxxxx-primary.active.focus,
    .btnxxxxxxx-primary.active:focus,
    .btnxxxxxxx-primary.active:hover,
    .btnxxxxxxx-primary:active.focus,
    .btnxxxxxxx-primary:active:focus,
    .btnxxxxxxx-primary:active:hover,
    .open>.btnxxxxxxx-primary.dropdown-toggle.focus,
    .open>.btnxxxxxxx-primary.dropdown-toggle:focus,
    .open>.btnxxxxxxx-primary.dropdown-toggle:hover {
    ...
    .btnxxxxxxx-primary.disabled.focus,
    .btnxxxxxxx-primary.disabled:focus,
    .btnxxxxxxx-primary.disabled:hover,
    .btnxxxxxxx-primary[disabled].focus,
    .btnxxxxxxx-primary[disabled]:focus,
    .btnxxxxxxx-primary[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-primary.focus,
    fieldset[disabled] .btnxxxxxxx-primary:focus,
    fieldset[disabled] .btnxxxxxxx-primary:hover {
      background-color: #ffdb00;
      border-color: #ffdb00
    }

    .btnxxxxxxx-primary .badge {
    ...
    .btnxxxxxxx-success.active,
    .btnxxxxxxx-success:active,
    .btnxxxxxxx-success:hover,
    .open>.btnxxxxxxx-success.dropdown-toggle {
      background-color: #589816;
      border-color: #467812;
      color: #fff
    }

    .btnxxxxxxx-success.active.focus,
    .btnxxxxxxx-success.active:focus,
    .btnxxxxxxx-success.active:hover,
    .btnxxxxxxx-success:active.focus,
    .btnxxxxxxx-success:active:focus,
    .btnxxxxxxx-success:active:hover,
    .open>.btnxxxxxxx-success.dropdown-toggle.focus,
    .open>.btnxxxxxxx-success.dropdown-toggle:focus,
    .open>.btnxxxxxxx-success.dropdown-toggle:hover {
    ...
    .btnxxxxxxx-success.disabled.focus,
    .btnxxxxxxx-success.disabled:focus,
    .btnxxxxxxx-success.disabled:hover,
    .btnxxxxxxx-success[disabled].focus,
    .btnxxxxxxx-success[disabled]:focus,
    .btnxxxxxxx-success[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-success.focus,
    fieldset[disabled] .btnxxxxxxx-success:focus,
    fieldset[disabled] .btnxxxxxxx-success:hover {
      background-color: #72c41d;
      border-color: #65ae1a
    }

    .btnxxxxxxx-success .badge {
      background-color: #fff;
      color: #72c41d
    }
    ...
    .btnxxxxxxx-info.active,
    .btnxxxxxxx-info:active,
    .btnxxxxxxx-info:hover,
    .open>.btnxxxxxxx-info.dropdown-toggle {
      background-color: #31b0d5;
      border-color: #269abc;
      color: #fff
    }

    .btnxxxxxxx-info.active.focus,
    .btnxxxxxxx-info.active:focus,
    .btnxxxxxxx-info.active:hover,
    .btnxxxxxxx-info:active.focus,
    .btnxxxxxxx-info:active:focus,
    .btnxxxxxxx-info:active:hover,
    .open>.btnxxxxxxx-info.dropdown-toggle.focus,
    .open>.btnxxxxxxx-info.dropdown-toggle:focus,
    .open>.btnxxxxxxx-info.dropdown-toggle:hover {
    ...
    .btnxxxxxxx-info.disabled.focus,
    .btnxxxxxxx-info.disabled:focus,
    .btnxxxxxxx-info.disabled:hover,
    .btnxxxxxxx-info[disabled].focus,
    .btnxxxxxxx-info[disabled]:focus,
    .btnxxxxxxx-info[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-info.focus,
    fieldset[disabled] .btnxxxxxxx-info:focus,
    fieldset[disabled] .btnxxxxxxx-info:hover {
      background-color: #5bc0de;
      border-color: #46b8da
    }

    .btnxxxxxxx-info .badge {
      background-color: #fff;
      color: #5bc0de
    }
    ...
    .btnxxxxxxx-inverted.active,
    .btnxxxxxxx-inverted:active,
    .btnxxxxxxx-inverted:hover,
    .open>.btnxxxxxxx-inverted.dropdown-toggle {
      background-color: #1d1c1c;
      border-color: #171717;
      color: #fff
    }

    .btnxxxxxxx-inverted.active.focus,
    .btnxxxxxxx-inverted.active:focus,
    .btnxxxxxxx-inverted.active:hover,
    .btnxxxxxxx-inverted:active.focus,
    .btnxxxxxxx-inverted:active:focus,
    .btnxxxxxxx-inverted:active:hover,
    .open>.btnxxxxxxx-inverted.dropdown-toggle.focus,
    .open>.btnxxxxxxx-inverted.dropdown-toggle:focus,
    .open>.btnxxxxxxx-inverted.dropdown-toggle:hover {
    ...
    .btnxxxxxxx-inverted.disabled.focus,
    .btnxxxxxxx-inverted.disabled:focus,
    .btnxxxxxxx-inverted.disabled:hover,
    .btnxxxxxxx-inverted[disabled].focus,
    .btnxxxxxxx-inverted[disabled]:focus,
    .btnxxxxxxx-inverted[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-inverted.focus,
    fieldset[disabled] .btnxxxxxxx-inverted:focus,
    fieldset[disabled] .btnxxxxxxx-inverted:hover {
      background-color: #363636;
      border-color: #363636
    }

    .btnxxxxxxx-inverted .badge {
      background-color: #fff;
      color: #363636
    }
    ...
    .btnxxxxxxx-warning.active,
    .btnxxxxxxx-warning:active,
    .btnxxxxxxx-warning:hover,
    .open>.btnxxxxxxx-warning.dropdown-toggle {
      background-color: #ec971f;
      border-color: #d58512;
      color: #fff
    }

    .btnxxxxxxx-warning.active.focus,
    .btnxxxxxxx-warning.active:focus,
    .btnxxxxxxx-warning.active:hover,
    .btnxxxxxxx-warning:active.focus,
    .btnxxxxxxx-warning:active:focus,
    .btnxxxxxxx-warning:active:hover,
    .open>.btnxxxxxxx-warning.dropdown-toggle.focus,
    .open>.btnxxxxxxx-warning.dropdown-toggle:focus,
    .open>.btnxxxxxxx-warning.dropdown-toggle:hover {
    ...
    .btnxxxxxxx-warning.disabled.focus,
    .btnxxxxxxx-warning.disabled:focus,
    .btnxxxxxxx-warning.disabled:hover,
    .btnxxxxxxx-warning[disabled].focus,
    .btnxxxxxxx-warning[disabled]:focus,
    .btnxxxxxxx-warning[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-warning.focus,
    fieldset[disabled] .btnxxxxxxx-warning:focus,
    fieldset[disabled] .btnxxxxxxx-warning:hover {
      background-color: #f0ad4e;
      border-color: #eea236
    }

    .btnxxxxxxx-warning .badge {
      background-color: #fff;
      color: #f0ad4e
    }
    ...
    .btnxxxxxxx-danger.active,
    .btnxxxxxxx-danger:active,
    .btnxxxxxxx-danger:hover,
    .open>.btnxxxxxxx-danger.dropdown-toggle {
      background-color: #c9302c;
      border-color: #ac2925;
      color: #fff
    }

    .btnxxxxxxx-danger.active.focus,
    .btnxxxxxxx-danger.active:focus,
    .btnxxxxxxx-danger.active:hover,
    .btnxxxxxxx-danger:active.focus,
    .btnxxxxxxx-danger:active:focus,
    .btnxxxxxxx-danger:active:hover,
    .open>.btnxxxxxxx-danger.dropdown-toggle.focus,
    .open>.btnxxxxxxx-danger.dropdown-toggle:focus,
    .open>.btnxxxxxxx-danger.dropdown-toggle:hover {
    ...
    .btnxxxxxxx-danger.disabled.focus,
    .btnxxxxxxx-danger.disabled:focus,
    .btnxxxxxxx-danger.disabled:hover,
    .btnxxxxxxx-danger[disabled].focus,
    .btnxxxxxxx-danger[disabled]:focus,
    .btnxxxxxxx-danger[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-danger.focus,
    fieldset[disabled] .btnxxxxxxx-danger:focus,
    fieldset[disabled] .btnxxxxxxx-danger:hover {
      background-color: #d9534f;
      border-color: #d43f3a
    }

    .btnxxxxxxx-danger .badge {
      background-color: #fff;
      color: #d9534f
    }
    ...
    .btnxxxxxxx-link,
    .btnxxxxxxx-link.active,
    .btnxxxxxxx-link:active,
    .btnxxxxxxx-link[disabled],
    fieldset[disabled] .btnxxxxxxx-link {
      background-color: transparent;
      -webkit-box-shadow: none;
      box-shadow: none
    }
    ...
    .btnxxxxxxx-link,
    .btnxxxxxxx-link:active,
    .btnxxxxxxx-link:focus,
    .btnxxxxxxx-link:hover {
    ...
    .btnxxxxxxx-link[disabled]:focus,
    .btnxxxxxxx-link[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-link:focus,
    fieldset[disabled] .btnxxxxxxx-link:hover {
      color: #777;
      text-decoration: none
    }

    .btnxxxxxxx-group-lg>.btnxxxxxxx,
    .btnxxxxxxx-lg,
    div.editor-orientation-landscape .tool-pane .footer .btnxxxxxxx {
      border-radius: 32px;
      font-size: 20px;
      line-height: 1.3333333;
      padding: 10px 16px
    ...
    .btnxxxxxxx-group-sm>.btnxxxxxxx,
    .btnxxxxxxx-sm {
      border-radius: 32px;
      font-size: 14px;
      line-height: 1.5;
    ...
    .btnxxxxxxx-group-xs>.btnxxxxxxx,
    .btnxxxxxxx-xs {
      border-radius: 32px;
      font-size: 14px;
      line-height: 1.5;
    ...
    .btnxxxxxxx-block+.btnxxxxxxx-block {
      margin-top: 5px
    }

    input[type=button].btnxxxxxxx-block,
    input[type=reset].btnxxxxxxx-block,
    input[type=submit].btnxxxxxxx-block {
      width: 100%
    }

    .btnxxxxxxx.btnxxxxxxx-buy {
      font-weight: 300
    }

    .btnxxxxxxx-group-lg>.btnxxxxxxx.btnxxxxxxx-buy,
    .btnxxxxxxx.btnxxxxxxx-buy.btnxxxxxxx-lg,
    div.editor-orientation-landscape .tool-pane .footer .btnxxxxxxx.btnxxxxxxx-buy {
      padding: 16px
    }

    .btnxxxxxxx.btnxxxxxxx-buy .border-left {
      border-left: 1px solid hsla(0, 0%, 100%, .1)
    }

    .btnxxxxxxx.btnxxxxxxx-buy .animated {
      -webkit-animation-duration: .5s;
      animation-duration: .5s
    }

    .btnxxxxxxx.btnxxxxxxx-buy:focus {
      outline: none
    }
    ...
    .navbar-collapse .btnxxxxxxx-checkout,
    ul.nav-mobile .btnxxxxxxx-checkout {
      background-color: #333
    }

    .navbar-collapse .btnxxxxxxx-checkout.affix:hover {
      background-color: #333;
      color: #fff
    }

    .btnxxxxxxx-checkout.animated {
      -webkit-animation-duration: .5s;
      animation-duration: .5s
    }

    .btnxxxxxxx-checkout.affix {
      position: fixed;
      top: 0
    }

    .btnxxxxxxx-checkout .inner {
      -webkit-animation-duration: .3s;
      animation-duration: .3s;
      display: block
    }

    .btnxxxxxxx.dropdown-toggle.text-ellipsis {
      text-align: left
    }

    .btnxxxxxxx.dropdown-toggle.text-ellipsis .caret {
      position: absolute;
      right: 4px;
      top: 15px
    }
    ...
    .btnxxxxxxx-xl.btnxxxxxxx-block {
      padding: 15px 0
    }
    ...
    .dropdown.caret-left .btnxxxxxxx-dropdown,
    .dropup.caret-left .btnxxxxxxx-dropdown {
      text-align: right
    }

    .dropdown.caret-left .btnxxxxxxx-dropdown:active,
    .dropdown.caret-left .btnxxxxxxx-dropdown:focus,
    .dropup.caret-left .btnxxxxxxx-dropdown:active,
    .dropup.caret-left .btnxxxxxxx-dropdown:focus {
      outline: 0
    }

    .dropdown.caret-left .btnxxxxxxx-dropdown .caret,
    .dropup.caret-left .btnxxxxxxx-dropdown .caret {
      left: 15px;
      position: absolute;
      top: 18px
    }

    .dropdown.caret-right .btnxxxxxxx-dropdown,
    .dropup.caret-right .btnxxxxxxx-dropdown {
      text-align: left
    }

    .dropdown.caret-right .btnxxxxxxx-dropdown:active,
    .dropdown.caret-right .btnxxxxxxx-dropdown:focus,
    .dropup.caret-right .btnxxxxxxx-dropdown:active,
    .dropup.caret-right .btnxxxxxxx-dropdown:focus {
      outline: 0
    }

    .dropdown.caret-right .btnxxxxxxx-dropdown .caret,
    .dropup.caret-right .btnxxxxxxx-dropdown .caret {
      position: absolute;
      right: 15px;
      top: 18px
    }
    ...
    .dropdown-menu>li>.btnxxxxxxx:focus,
    .dropdown-menu>li>.btnxxxxxxx:hover,
    ...
    .dropdown-menu>li>.btnxxxxxxx.active,
    .dropdown-menu>li>.btnxxxxxxx.active:focus,
    .dropdown-menu>li>.btnxxxxxxx.active:hover {
    ...
    .btnxxxxxxx-group,
    .btnxxxxxxx-group-vertical {
      display: inline-block;
      position: relative;
      vertical-align: middle
    }

    .btnxxxxxxx-group-vertical>.btnxxxxxxx,
    .btnxxxxxxx-group>.btnxxxxxxx {
      float: left;
      position: relative
    }

    .btnxxxxxxx-group-vertical>.btnxxxxxxx.active,
    .btnxxxxxxx-group-vertical>.btnxxxxxxx:active,
    .btnxxxxxxx-group-vertical>.btnxxxxxxx:focus,
    .btnxxxxxxx-group-vertical>.btnxxxxxxx:hover,
    .btnxxxxxxx-group>.btnxxxxxxx.active,
    .btnxxxxxxx-group>.btnxxxxxxx:active,
    .btnxxxxxxx-group>.btnxxxxxxx:focus,
    .btnxxxxxxx-group>.btnxxxxxxx:hover {
      z-index: 2
    }

    .btnxxxxxxx-group .btnxxxxxxx+.btnxxxxxxx,
    .btnxxxxxxx-group .btnxxxxxxx+.btnxxxxxxx-group,
    .btnxxxxxxx-group .btnxxxxxxx-group+.btnxxxxxxx,
    .btnxxxxxxx-group .btnxxxxxxx-group+.btnxxxxxxx-group {
      margin-left: -1px
    }
    ...
    .btnxxxxxxx-toolbar:after,
    .btnxxxxxxx-toolbar:before {
      content: " ";
      display: table
    }
    ...
    .btnxxxxxxx-toolbar .btnxxxxxxx,
    .btnxxxxxxx-toolbar .btnxxxxxxx-group,
    .btnxxxxxxx-toolbar .input-group {
      float: left
    }
    ...
    .btnxxxxxxx-group>.btnxxxxxxx:not(:first-child):not(:last-child):not(.dropdown-toggle) {
      border-radius: 0
    }

    .btnxxxxxxx-group>.btnxxxxxxx:first-child {
      margin-left: 0
    }

    .btnxxxxxxx-group>.btnxxxxxxx:first-child:not(:last-child):not(.dropdown-toggle) {
      border-bottom-right-radius: 0;
      border-top-right-radius: 0
    }

    .btnxxxxxxx-group>.btnxxxxxxx:last-child:not(:first-child),
    .btnxxxxxxx-group>.dropdown-toggle:not(:first-child) {
      border-bottom-left-radius: 0;
      border-top-left-radius: 0
    }

    .btnxxxxxxx-group>.btnxxxxxxx-group {
      float: left
    }

    .btnxxxxxxx-group>.btnxxxxxxx-group:not(:first-child):not(:last-child)>.btnxxxxxxx {
      border-radius: 0
    }

    .btnxxxxxxx-group>.btnxxxxxxx-group:first-child:not(:last-child)>.btnxxxxxxx:last-child,
    .btnxxxxxxx-group>.btnxxxxxxx-group:first-child:not(:last-child)>.dropdown-toggle {
      border-bottom-right-radius: 0;
      border-top-right-radius: 0
    }

    .btnxxxxxxx-group>.btnxxxxxxx-group:last-child:not(:first-child)>.btnxxxxxxx:first-child {
      border-bottom-left-radius: 0;
      border-top-left-radius: 0
    }

    .btnxxxxxxx-group .dropdown-toggle:active,
    .btnxxxxxxx-group.open .dropdown-toggle {
      outline: 0
    }

    .btnxxxxxxx-group>.btnxxxxxxx+.dropdown-toggle {
      padding-left: 8px;
      padding-right: 8px
    }

    .btnxxxxxxx-group-lg.btnxxxxxxx-group>.btnxxxxxxx+.dropdown-toggle,
    .btnxxxxxxx-group>.btnxxxxxxx-lg+.dropdown-toggle,
    div.editor-orientation-landscape .tool-pane .footer .btnxxxxxxx-group>.btnxxxxxxx+.dropdown-toggle {
      padding-left: 12px;
      padding-right: 12px
    }
    ...
    .btnxxxxxxx-group.open .dropdown-toggle.btnxxxxxxx-link {
      -webkit-box-shadow: none;
      box-shadow: none
    }
    ...
    .btnxxxxxxx-group-lg>.btnxxxxxxx .caret,
    .btnxxxxxxx-lg .caret,
    div.editor-orientation-landscape .tool-pane .footer .btnxxxxxxx .caret {
      border-width: 5px 5px 0
    }

    .dropup .btnxxxxxxx-group-lg>.btnxxxxxxx .caret,
    .dropup .btnxxxxxxx-lg .caret,
    .dropup div.editor-orientation-landscape .tool-pane .footer .btnxxxxxxx .caret,
    div.editor-orientation-landscape .tool-pane .footer .dropup .btnxxxxxxx .caret {
      border-width: 0 5px 5px
    }

    .btnxxxxxxx-group-vertical>.btnxxxxxxx,
    .btnxxxxxxx-group-vertical>.btnxxxxxxx-group,
    .btnxxxxxxx-group-vertical>.btnxxxxxxx-group>.btnxxxxxxx {
      display: block;
      float: none;
      max-width: 100%;
      width: 100%
    ...
    .btnxxxxxxx-group-vertical>.btnxxxxxxx-group:after,
    .btnxxxxxxx-group-vertical>.btnxxxxxxx-group:before {
      content: " ";
      display: table
    }
    ...
    .btnxxxxxxx-group-vertical>.btnxxxxxxx+.btnxxxxxxx,
    .btnxxxxxxx-group-vertical>.btnxxxxxxx+.btnxxxxxxx-group,
    .btnxxxxxxx-group-vertical>.btnxxxxxxx-group+.btnxxxxxxx,
    .btnxxxxxxx-group-vertical>.btnxxxxxxx-group+.btnxxxxxxx-group {
      margin-left: 0;
      margin-top: -1px
    }

    .btnxxxxxxx-group-vertical>.btnxxxxxxx:not(:first-child):not(:last-child) {
      border-radius: 0
    }

    .btnxxxxxxx-group-vertical>.btnxxxxxxx:first-child:not(:last-child) {
      border-bottom-left-radius: 0;
      border-bottom-right-radius: 0;
    ...
    .btnxxxxxxx-group-vertical>.btnxxxxxxx:last-child:not(:first-child) {
    ...
    .btnxxxxxxx-group-vertical>.btnxxxxxxx-group:not(:first-child):not(:last-child)>.btnxxxxxxx {
      border-radius: 0
    }

    .btnxxxxxxx-group-vertical>.btnxxxxxxx-group:first-child:not(:last-child)>.btnxxxxxxx:last-child,
    .btnxxxxxxx-group-vertical>.btnxxxxxxx-group:first-child:not(:last-child)>.dropdown-toggle {
      border-bottom-left-radius: 0;
      border-bottom-right-radius: 0
    }

    .btnxxxxxxx-group-vertical>.btnxxxxxxx-group:last-child:not(:first-child)>.btnxxxxxxx:first-child {
      border-top-left-radius: 0;
      border-top-right-radius: 0
    }

    .btnxxxxxxx-group-justified {
    ...
    .btnxxxxxxx-group-justified>.btnxxxxxxx,
    .btnxxxxxxx-group-justified>.btnxxxxxxx-group {
      display: table-cell;
      float: none;
      width: 1%
    }

    .btnxxxxxxx-group-justified>.btnxxxxxxx-group .btnxxxxxxx {
      width: 100%
    }

    .btnxxxxxxx-group-justified>.btnxxxxxxx-group .dropdown-menu {
      left: auto
    }

    [data-toggle=buttons]>.btnxxxxxxx input[type=checkbox],
    [data-toggle=buttons]>.btnxxxxxxx input[type=radio],
    [data-toggle=buttons]>.btnxxxxxxx-group>.btnxxxxxxx input[type=checkbox],
    [data-toggle=buttons]>.btnxxxxxxx-group>.btnxxxxxxx input[type=radio] {
      clip: rect(0, 0, 0, 0);
      pointer-events: none;
      position: absolute
    }
    ...
    .input-group-sm>.input-group-addon,
    .input-group-sm>.input-group-btn>.input-group-addon.btnxxxxxxx {
      border-radius: 3px;
      font-size: 14px;
      padding: 5px 10px
    }
    ...
    .input-group-lg>.input-group-addon,
    .input-group-lg>.input-group-btn>.input-group-addon.btnxxxxxxx {
      border-radius: 6px;
      font-size: 20px;
      padding: 10px 16px
    }
    ...
    .input-group-btn:first-child>.btnxxxxxxx,
    .input-group-btn:first-child>.btnxxxxxxx-group>.btnxxxxxxx,
    .input-group-btn:first-child>.dropdown-toggle,
    .input-group-btn:last-child>.btnxxxxxxx-group:not(:last-child)>.btnxxxxxxx,
    .input-group-btn:last-child>.btnxxxxxxx:not(:last-child):not(.dropdown-toggle) {
      border-bottom-right-radius: 0;
      border-top-right-radius: 0
    }
    ...
    .input-group-btn:first-child>.btnxxxxxxx-group:not(:first-child)>.btnxxxxxxx,
    .input-group-btn:first-child>.btnxxxxxxx:not(:first-child),
    .input-group-btn:last-child>.btnxxxxxxx,
    .input-group-btn:last-child>.btnxxxxxxx-group>.btnxxxxxxx,
    ...
    .input-group-btn,
    .input-group-btn>.btnxxxxxxx {
      position: relative
    }

    .input-group-btn>.btnxxxxxxx+.btnxxxxxxx {
      margin-left: -1px
    }

    .input-group-btn>.btnxxxxxxx:active,
    .input-group-btn>.btnxxxxxxx:focus,
    .input-group-btn>.btnxxxxxxx:hover {
      z-index: 2
    }

    .input-group-btn:first-child>.btnxxxxxxx,
    .input-group-btn:first-child>.btnxxxxxxx-group {
      margin-right: -1px
    }

    .input-group-btn:last-child>.btnxxxxxxx,
    .input-group-btn:last-child>.btnxxxxxxx-group {
      margin-left: -1px;
      z-index: 2
    }
    ...
    .btnxxxxxxx-group-sm>.navbar-btn.btnxxxxxxx,
    .navbar-btn.btnxxxxxxx-sm {
      margin-bottom: 13.5px;
      margin-top: 13.5px
    }

    .btnxxxxxxx-group-xs>.navbar-btn.btnxxxxxxx,
    .navbar-btn.btnxxxxxxx-xs,
    .navbar-text {
      margin-bottom: 19px;
      margin-top: 19px
    }
    ...
    .navbar-default .btnxxxxxxx-link {
      color: #777
    }

    .navbar-default .btnxxxxxxx-link:focus,
    .navbar-default .btnxxxxxxx-link:hover {
      color: #333
    }

    .navbar-default .btnxxxxxxx-link[disabled]:focus,
    .navbar-default .btnxxxxxxx-link[disabled]:hover,
    fieldset[disabled] .navbar-default .btnxxxxxxx-link:focus,
    fieldset[disabled] .navbar-default .btnxxxxxxx-link:hover {
      color: #ccc
    }
    ...
    .navbar-inverse .btnxxxxxxx-link {
      color: #fff
    }

    .navbar-inverse .btnxxxxxxx-link:focus,
    .navbar-inverse .btnxxxxxxx-link:hover {
      color: #ddd
    }

    .navbar-inverse .btnxxxxxxx-link[disabled]:focus,
    .navbar-inverse .btnxxxxxxx-link[disabled]:hover,
    fieldset[disabled] .navbar-inverse .btnxxxxxxx-link:focus,
    fieldset[disabled] .navbar-inverse .btnxxxxxxx-link:hover {
      color: #444
    }
    ...
    .modal-footer .btnxxxxxxx+.btnxxxxxxx {
      margin-bottom: 0;
      margin-left: 5px
    }

    .modal-footer .btnxxxxxxx-group .btnxxxxxxx+.btnxxxxxxx {
      margin-left: -1px
    }

    .modal-footer .btnxxxxxxx-block+.btnxxxxxxx-block {
      margin-left: 0
    }
    ...
    .stapp-nav.top ul.nav>li>a.btnxxxxxxx-primary {
      color: #fff;
      height: 34px;
      line-height: 34px;
      margin: 8px 15px 0 0;
    ...
    .stapp-nav ul.nav>li>a.btnxxxxxxx-primary:hover {
      background: #3276b1
    }
    ...
    @media (max-width:767px) {
      ...
      .products .figure .item-wrapper .btnxxxxxxx {
        font-size: 12px
      }
    ...
    .btnxxxxxxx-dark.active,
    .btnxxxxxxx-dark:active,
    .btnxxxxxxx-dark:hover,
    .open>.btnxxxxxxx-dark.dropdown-toggle {
      background-color: #211f1f;
      border-color: #1c1a1a;
      color: #fff
    }

    .btnxxxxxxx-dark.active.focus,
    .btnxxxxxxx-dark.active:focus,
    .btnxxxxxxx-dark.active:hover,
    .btnxxxxxxx-dark:active.focus,
    .btnxxxxxxx-dark:active:focus,
    .btnxxxxxxx-dark:active:hover,
    .open>.btnxxxxxxx-dark.dropdown-toggle.focus,
    .open>.btnxxxxxxx-dark.dropdown-toggle:focus,
    .open>.btnxxxxxxx-dark.dropdown-toggle:hover {
    ...
    .btnxxxxxxx-dark.disabled.focus,
    .btnxxxxxxx-dark.disabled:focus,
    .btnxxxxxxx-dark.disabled:hover,
    .btnxxxxxxx-dark[disabled].focus,
    .btnxxxxxxx-dark[disabled]:focus,
    .btnxxxxxxx-dark[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-dark.focus,
    fieldset[disabled] .btnxxxxxxx-dark:focus,
    fieldset[disabled] .btnxxxxxxx-dark:hover {
      background-color: #3c3738;
      border-color: #3c3738
    }

    .btnxxxxxxx-dark .badge {
      background-color: #fff;
      color: #3c3738
    }
    ...
    .btnxxxxxxx-outline:hover {
      background-color: transparent;
      border-color: transparent;
      color: #ffdb00
    }

    .btnxxxxxxx-outline.active,
    .btnxxxxxxx-outline:active,
    .open>.btnxxxxxxx-outline.dropdown-toggle {
      background-color: transparent;
      border-color: transparent;
      color: #b39900
    }

    .btnxxxxxxx-outline.active.focus,
    .btnxxxxxxx-outline.active:focus,
    .btnxxxxxxx-outline.active:hover,
    .btnxxxxxxx-outline:active.focus,
    .btnxxxxxxx-outline:active:focus,
    .btnxxxxxxx-outline:active:hover,
    .open>.btnxxxxxxx-outline.dropdown-toggle.focus,
    .open>.btnxxxxxxx-outline.dropdown-toggle:focus,
    .open>.btnxxxxxxx-outline.dropdown-toggle:hover {
      background-color: transparent;
      border-color: transparent;
      color: #b39900;
      outline: none
    ...
    .btnxxxxxxx-outline.disabled.focus,
    .btnxxxxxxx-outline.disabled:focus,
    .btnxxxxxxx-outline.disabled:hover,
    .btnxxxxxxx-outline[disabled].focus,
    .btnxxxxxxx-outline[disabled]:focus,
    .btnxxxxxxx-outline[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-outline.focus,
    fieldset[disabled] .btnxxxxxxx-outline:focus,
    fieldset[disabled] .btnxxxxxxx-outline:hover {
      background-color: transparent;
      border-color: transparent
    }

    .btnxxxxxxx-outline .badge {
      background-color: #ffdb00;
      color: transparent
    }
    ...
    .btnxxxxxxx-buy.focus,
    .btnxxxxxxx-buy:focus,
    .btnxxxxxxx-save.focus,
    .btnxxxxxxx-save:focus {
      background-color: #ccaf00;
      border-color: #806e00;
      color: #040404;
    ...
    .btnxxxxxxx-buy.active,
    .btnxxxxxxx-buy:active,
    .btnxxxxxxx-buy:hover,
    .btnxxxxxxx-save.active,
    .btnxxxxxxx-save:active,
    .btnxxxxxxx-save:hover,
    .open>.btnxxxxxxx-buy.dropdown-toggle,
    .open>.btnxxxxxxx-save.dropdown-toggle {
      background-color: #ccaf00;
      border-color: #c2a600;
      color: #040404
    }

    .btnxxxxxxx-buy.active.focus,
    .btnxxxxxxx-buy.active:focus,
    .btnxxxxxxx-buy.active:hover,
    .btnxxxxxxx-buy:active.focus,
    .btnxxxxxxx-buy:active:focus,
    .btnxxxxxxx-buy:active:hover,
    .btnxxxxxxx-save.active.focus,
    .btnxxxxxxx-save.active:focus,
    .btnxxxxxxx-save.active:hover,
    .btnxxxxxxx-save:active.focus,
    .btnxxxxxxx-save:active:focus,
    .btnxxxxxxx-save:active:hover,
    .open>.btnxxxxxxx-buy.dropdown-toggle.focus,
    .open>.btnxxxxxxx-buy.dropdown-toggle:focus,
    .open>.btnxxxxxxx-buy.dropdown-toggle:hover,
    .open>.btnxxxxxxx-save.dropdown-toggle.focus,
    .open>.btnxxxxxxx-save.dropdown-toggle:focus,
    .open>.btnxxxxxxx-save.dropdown-toggle:hover {
      background-color: #a89100;
      border-color: #806e00;
      color: #040404;
      outline: none
    ...
    .btnxxxxxxx-buy.disabled.focus,
    .btnxxxxxxx-buy.disabled:focus,
    .btnxxxxxxx-buy.disabled:hover,
    .btnxxxxxxx-buy[disabled].focus,
    .btnxxxxxxx-buy[disabled]:focus,
    .btnxxxxxxx-buy[disabled]:hover,
    .btnxxxxxxx-save.disabled.focus,
    .btnxxxxxxx-save.disabled:focus,
    .btnxxxxxxx-save.disabled:hover,
    .btnxxxxxxx-save[disabled].focus,
    .btnxxxxxxx-save[disabled]:focus,
    .btnxxxxxxx-save[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-buy.focus,
    fieldset[disabled] .btnxxxxxxx-buy:focus,
    fieldset[disabled] .btnxxxxxxx-buy:hover,
    fieldset[disabled] .btnxxxxxxx-save.focus,
    fieldset[disabled] .btnxxxxxxx-save:focus,
    fieldset[disabled] .btnxxxxxxx-save:hover {
      background-color: #ffdb00;
      border-color: #ffdb00
    }

    .btnxxxxxxx-buy .badge,
    .btnxxxxxxx-save .badge {
      background-color: #040404;
      color: #ffdb00
    }
    ...
    .btnxxxxxxx-done.active,
    .btnxxxxxxx-done:active,
    .btnxxxxxxx-done:hover,
    .open>.btnxxxxxxx-done.dropdown-toggle {
      background-color: #2276d6;
      border-color: #2171cd;
      color: #fff
    }

    .btnxxxxxxx-done.active.focus,
    .btnxxxxxxx-done.active:focus,
    .btnxxxxxxx-done.active:hover,
    .btnxxxxxxx-done:active.focus,
    .btnxxxxxxx-done:active:focus,
    .btnxxxxxxx-done:active:hover,
    .open>.btnxxxxxxx-done.dropdown-toggle.focus,
    .open>.btnxxxxxxx-done.dropdown-toggle:focus,
    .open>.btnxxxxxxx-done.dropdown-toggle:hover {
    ...
    .btnxxxxxxx-done.disabled.focus,
    .btnxxxxxxx-done.disabled:focus,
    .btnxxxxxxx-done.disabled:hover,
    .btnxxxxxxx-done[disabled].focus,
    .btnxxxxxxx-done[disabled]:focus,
    .btnxxxxxxx-done[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-done.focus,
    fieldset[disabled] .btnxxxxxxx-done:focus,
    fieldset[disabled] .btnxxxxxxx-done:hover {
      background-color: #4990e2;
      border-color: #4990e2
    }

    .btnxxxxxxx-done .badge {
      background-color: #fff;
      color: #4990e2
    }
    ...
    .btnxxxxxxx-gray.focus,
    .btnxxxxxxx-gray:focus,
    .btnxxxxxxx-grey.focus,
    .btnxxxxxxx-grey:focus {
      background-color: #141313;
      border-color: #939ea7;
      color: #ffdb00;
    ...
    .btnxxxxxxx-gray.active,
    .btnxxxxxxx-gray:active,
    .btnxxxxxxx-gray:hover,
    .btnxxxxxxx-grey.active,
    .btnxxxxxxx-grey:active,
    .btnxxxxxxx-grey:hover,
    .open>.btnxxxxxxx-gray.dropdown-toggle,
    .open>.btnxxxxxxx-grey.dropdown-toggle {
      background-color: #141313;
      border-color: #b7bfc5;
      color: #ffdb00
    }

    .btnxxxxxxx-gray.active.focus,
    .btnxxxxxxx-gray.active:focus,
    .btnxxxxxxx-gray.active:hover,
    .btnxxxxxxx-gray:active.focus,
    .btnxxxxxxx-gray:active:focus,
    .btnxxxxxxx-gray:active:hover,
    .btnxxxxxxx-grey.active.focus,
    .btnxxxxxxx-grey.active:focus,
    .btnxxxxxxx-grey.active:hover,
    .btnxxxxxxx-grey:active.focus,
    .btnxxxxxxx-grey:active:focus,
    .btnxxxxxxx-grey:active:hover,
    .open>.btnxxxxxxx-gray.dropdown-toggle.focus,
    .open>.btnxxxxxxx-gray.dropdown-toggle:focus,
    .open>.btnxxxxxxx-gray.dropdown-toggle:hover,
    .open>.btnxxxxxxx-grey.dropdown-toggle.focus,
    .open>.btnxxxxxxx-grey.dropdown-toggle:focus,
    .open>.btnxxxxxxx-grey.dropdown-toggle:hover {
      background-color: #020202;
      border-color: #939ea7;
      color: #ffdb00;
      outline: none
    ...
    .btnxxxxxxx-gray.disabled.focus,
    .btnxxxxxxx-gray.disabled:focus,
    .btnxxxxxxx-gray.disabled:hover,
    .btnxxxxxxx-gray[disabled].focus,
    .btnxxxxxxx-gray[disabled]:focus,
    .btnxxxxxxx-gray[disabled]:hover,
    .btnxxxxxxx-grey.disabled.focus,
    .btnxxxxxxx-grey.disabled:focus,
    .btnxxxxxxx-grey.disabled:hover,
    .btnxxxxxxx-grey[disabled].focus,
    .btnxxxxxxx-grey[disabled]:focus,
    .btnxxxxxxx-grey[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-gray.focus,
    fieldset[disabled] .btnxxxxxxx-gray:focus,
    fieldset[disabled] .btnxxxxxxx-gray:hover,
    fieldset[disabled] .btnxxxxxxx-grey.focus,
    fieldset[disabled] .btnxxxxxxx-grey:focus,
    fieldset[disabled] .btnxxxxxxx-grey:hover {
      background-color: #2d2d2d;
      border-color: #d9dde0
    }

    .btnxxxxxxx-gray .badge,
    .btnxxxxxxx-grey .badge {
      background-color: #ffdb00;
      color: #2d2d2d
    }
    ...
    .btnxxxxxxx-fb.active,
    .btnxxxxxxx-fb:active,
    .btnxxxxxxx-fb:hover,
    .open>.btnxxxxxxx-fb.dropdown-toggle {
      background-color: #285f8f;
      border-color: #265a87;
      color: #fff
    }

    .btnxxxxxxx-fb.active.focus,
    .btnxxxxxxx-fb.active:focus,
    .btnxxxxxxx-fb.active:hover,
    .btnxxxxxxx-fb:active.focus,
    .btnxxxxxxx-fb:active:focus,
    .btnxxxxxxx-fb:active:hover,
    .open>.btnxxxxxxx-fb.dropdown-toggle.focus,
    .open>.btnxxxxxxx-fb.dropdown-toggle:focus,
    .open>.btnxxxxxxx-fb.dropdown-toggle:hover {
    ...
    .btnxxxxxxx-fb.disabled.focus,
    .btnxxxxxxx-fb.disabled:focus,
    .btnxxxxxxx-fb.disabled:hover,
    .btnxxxxxxx-fb[disabled].focus,
    .btnxxxxxxx-fb[disabled]:focus,
    .btnxxxxxxx-fb[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-fb.focus,
    fieldset[disabled] .btnxxxxxxx-fb:focus,
    fieldset[disabled] .btnxxxxxxx-fb:hover {
      background-color: #337ab7;
      border-color: #337ab7
    }
    ...
    html[lang=fi] .btnxxxxxxx-fb,
    html[lang=fi] .btnxxxxxxx-google,
    html[lang=pl] .btnxxxxxxx-fb,
    html[lang=pl] .btnxxxxxxx-google {
      font-size: 11px
    }
    ...
    .btnxxxxxxx-dropdown:active,
    .btnxxxxxxx-dropdown:focus,
    .btnxxxxxxx-dropdown:hover {
      border-color: #b9bec1;
    ...
    .btnxxxxxxx.btnxxxxxxx-xl {
      padding: 12px 28px 11px
    }

    .btnxxxxxxx-group-sm>.btnxxxxxxx,
    .btnxxxxxxx.btnxxxxxxx-sm {
      font-size: 12px;
      padding: 8px 15px
    }

    .btnxxxxxxx-group-xs>.btnxxxxxxx,
    .btnxxxxxxx.btnxxxxxxx-xs {
      font-size: 12px;
      padding: 2px 10px 1px
    }

    html[lang=pl] .btnxxxxxxx {
      font-family: Helvetica, Arial, sans-serif
    }
    ...
    @media (max-width:359px) {
      ...
      .modal-login .btnxxxxxxx-group-lg>.btnxxxxxxx,
      .modal-login .btnxxxxxxx-lg,
      .modal-login div.editor-orientation-landscape .tool-pane .footer .btnxxxxxxx,
      div.editor-orientation-landscape .tool-pane .footer .modal-login .btnxxxxxxx {
        font-size: 12px
      }
    }
    ...
    .materials .btnxxxxxxx.btnxxxxxxx-hero {
      margin: 15px 30px
    }

    .btnxxxxxxx.btnxxxxxxx-hero.material-btn-gray {
      background-color: #d3d3d3;
      color: #040404
    }

    .btnxxxxxxx.btnxxxxxxx-hero:before {
    ...
    .btnxxxxxxx.btnxxxxxxx-hero.material-btn-gray:before {
      border: 1.5px solid #d3d3d3
    }

    .btnxxxxxxx.btnxxxxxxx-hero.material-btn-gray:hover {
      background-color: gray
    }

    .materials .container .btnxxxxxxx-gray,
    .materials .container .btnxxxxxxx-primary {
      margin: 15px 30px
    }

    @media (max-width:767px) {
      .btnxxxxxxx.btnxxxxxxx-xl.btnxxxxxxx-hero {
        font-size: 15px
      }

      html[lang=es] .btnxxxxxxx.btnxxxxxxx-xl.btnxxxxxxx-hero {
        font-size: 14px
      }

      html[lang=it] .btnxxxxxxx.btnxxxxxxx-xl.btnxxxxxxx-hero,
      html[lang=pt] .btnxxxxxxx.btnxxxxxxx-xl.btnxxxxxxx-hero {
        font-size: 11px
      }

      html[lang=pt] .start .btnxxxxxxx-start-section {
        font-size: 15px
      }
    }

    .btnxxxxxxx-cta.btnxxxxxxx-default {
      background-color: #2d2d2d;
      border: none;
      color: #ffdb00;
      position: relative
    ...
    .btnxxxxxxx-cta.btnxxxxxxx-default:before {
    ...
    .btnxxxxxxx-cta.btnxxxxxxx-default.focus,
    .btnxxxxxxx-cta.btnxxxxxxx-default:focus {
      background-color: #141313;
      border-color: #070707;
      color: #b39900;
    ...
    .btnxxxxxxx-cta.btnxxxxxxx-default:hover {
      background-color: #141313;
      border-color: #2d2d2d;
      color: #ffdb00
    }

    .btnxxxxxxx-cta.btnxxxxxxx-default.active,
    .btnxxxxxxx-cta.btnxxxxxxx-default:active,
    .open>.btnxxxxxxx-cta.btnxxxxxxx-default.dropdown-toggle {
      background-color: #141313;
      border-color: #070707;
      color: #b39900
    }

    .btnxxxxxxx-cta.btnxxxxxxx-default.active.focus,
    .btnxxxxxxx-cta.btnxxxxxxx-default.active:focus,
    .btnxxxxxxx-cta.btnxxxxxxx-default.active:hover,
    .btnxxxxxxx-cta.btnxxxxxxx-default:active.focus,
    .btnxxxxxxx-cta.btnxxxxxxx-default:active:focus,
    .btnxxxxxxx-cta.btnxxxxxxx-default:active:hover,
    .open>.btnxxxxxxx-cta.btnxxxxxxx-default.dropdown-toggle.focus,
    .open>.btnxxxxxxx-cta.btnxxxxxxx-default.dropdown-toggle:focus,
    .open>.btnxxxxxxx-cta.btnxxxxxxx-default.dropdown-toggle:hover {
      background-color: #020202;
      border-color: #070707;
      color: #b39900;
      outline: none
    ...
    .btnxxxxxxx-cta.btnxxxxxxx-default.disabled.focus,
    .btnxxxxxxx-cta.btnxxxxxxx-default.disabled:focus,
    .btnxxxxxxx-cta.btnxxxxxxx-default.disabled:hover,
    .btnxxxxxxx-cta.btnxxxxxxx-default[disabled].focus,
    .btnxxxxxxx-cta.btnxxxxxxx-default[disabled]:focus,
    .btnxxxxxxx-cta.btnxxxxxxx-default[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-cta.btnxxxxxxx-default.focus,
    fieldset[disabled] .btnxxxxxxx-cta.btnxxxxxxx-default:focus,
    fieldset[disabled] .btnxxxxxxx-cta.btnxxxxxxx-default:hover {
      background-color: #2d2d2d;
      border-color: #2d2d2d
    }

    .btnxxxxxxx-cta.btnxxxxxxx-default .badge {
      background-color: #ffdb00;
      color: #2d2d2d
    }

    .btnxxxxxxx-cta.btnxxxxxxx-primary {
      background-color: #ffdb00;
      border: none;
      color: #040404;
      position: relative
    ...
    .btnxxxxxxx-cta.btnxxxxxxx-primary:before {
    ...
    .btnxxxxxxx-cta.btnxxxxxxx-primary.focus,
    .btnxxxxxxx-cta.btnxxxxxxx-primary:focus {
      background-color: #ccaf00;
      border-color: #b39900;
      color: #000;
    ...
    .btnxxxxxxx-cta.btnxxxxxxx-primary:hover {
      background-color: #ccaf00;
      border-color: #ffdb00;
      color: #040404
    }

    .btnxxxxxxx-cta.btnxxxxxxx-primary.active,
    .btnxxxxxxx-cta.btnxxxxxxx-primary:active,
    .open>.btnxxxxxxx-cta.btnxxxxxxx-primary.dropdown-toggle {
      background-color: #ccaf00;
      border-color: #b39900;
      color: #000
    }

    .btnxxxxxxx-cta.btnxxxxxxx-primary.active.focus,
    .btnxxxxxxx-cta.btnxxxxxxx-primary.active:focus,
    .btnxxxxxxx-cta.btnxxxxxxx-primary.active:hover,
    .btnxxxxxxx-cta.btnxxxxxxx-primary:active.focus,
    .btnxxxxxxx-cta.btnxxxxxxx-primary:active:focus,
    .btnxxxxxxx-cta.btnxxxxxxx-primary:active:hover,
    .open>.btnxxxxxxx-cta.btnxxxxxxx-primary.dropdown-toggle.focus,
    .open>.btnxxxxxxx-cta.btnxxxxxxx-primary.dropdown-toggle:focus,
    .open>.btnxxxxxxx-cta.btnxxxxxxx-primary.dropdown-toggle:hover {
      background-color: #a89100;
      border-color: #b39900;
      color: #000;
      outline: none
    ...
    .btnxxxxxxx-cta.btnxxxxxxx-primary.disabled.focus,
    .btnxxxxxxx-cta.btnxxxxxxx-primary.disabled:focus,
    .btnxxxxxxx-cta.btnxxxxxxx-primary.disabled:hover,
    .btnxxxxxxx-cta.btnxxxxxxx-primary[disabled].focus,
    .btnxxxxxxx-cta.btnxxxxxxx-primary[disabled]:focus,
    .btnxxxxxxx-cta.btnxxxxxxx-primary[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-cta.btnxxxxxxx-primary.focus,
    fieldset[disabled] .btnxxxxxxx-cta.btnxxxxxxx-primary:focus,
    fieldset[disabled] .btnxxxxxxx-cta.btnxxxxxxx-primary:hover {
      background-color: #ffdb00;
      border-color: #ffdb00
    }

    .btnxxxxxxx-cta.btnxxxxxxx-primary .badge {
      background-color: #040404;
      color: #ffdb00
    }

    .btnxxxxxxx-cta.btnxxxxxxx-alert {
    ...
    .btnxxxxxxx-cta.btnxxxxxxx-alert:before {
    ...
    .btnxxxxxxx-cta.btnxxxxxxx-alert.focus,
    .btnxxxxxxx-cta.btnxxxxxxx-alert:focus {
    ...
    .btnxxxxxxx-cta.btnxxxxxxx-alert:hover {
      background-color: #c63428;
      border-color: #da5246;
      color: #fff
    }

    .btnxxxxxxx-cta.btnxxxxxxx-alert.active,
    .btnxxxxxxx-cta.btnxxxxxxx-alert:active,
    .open>.btnxxxxxxx-cta.btnxxxxxxx-alert.dropdown-toggle {
      background-color: #c63428;
      border-color: #b02f23;
      color: #d9d9d9
    }

    .btnxxxxxxx-cta.btnxxxxxxx-alert.active.focus,
    .btnxxxxxxx-cta.btnxxxxxxx-alert.active:focus,
    .btnxxxxxxx-cta.btnxxxxxxx-alert.active:hover,
    .btnxxxxxxx-cta.btnxxxxxxx-alert:active.focus,
    .btnxxxxxxx-cta.btnxxxxxxx-alert:active:focus,
    .btnxxxxxxx-cta.btnxxxxxxx-alert:active:hover,
    .open>.btnxxxxxxx-cta.btnxxxxxxx-alert.dropdown-toggle.focus,
    .open>.btnxxxxxxx-cta.btnxxxxxxx-alert.dropdown-toggle:focus,
    .open>.btnxxxxxxx-cta.btnxxxxxxx-alert.dropdown-toggle:hover {
    ...
    .btnxxxxxxx-cta.btnxxxxxxx-alert.disabled.focus,
    .btnxxxxxxx-cta.btnxxxxxxx-alert.disabled:focus,
    .btnxxxxxxx-cta.btnxxxxxxx-alert.disabled:hover,
    .btnxxxxxxx-cta.btnxxxxxxx-alert[disabled].focus,
    .btnxxxxxxx-cta.btnxxxxxxx-alert[disabled]:focus,
    .btnxxxxxxx-cta.btnxxxxxxx-alert[disabled]:hover,
    fieldset[disabled] .btnxxxxxxx-cta.btnxxxxxxx-alert.focus,
    fieldset[disabled] .btnxxxxxxx-cta.btnxxxxxxx-alert:focus,
    fieldset[disabled] .btnxxxxxxx-cta.btnxxxxxxx-alert:hover {
      background-color: #da5246;
      border-color: #da5246
    }

    .btnxxxxxxx-cta.btnxxxxxxx-alert .badge {
      background-color: #fff;
      color: #da5246
    }
    ...
    .btnxxxxxxx .glyphicon-menu-left,
    .btnxxxxxxx .glyphicon-menu-right {
      font-size: 80%
    }
    ...
    .sticker-wizard .input-group-sm>.input-group-btn>.btnxxxxxxx,
    ...
    .single-giftcard-tile .btnxxxxxxx {
      margin-top: 40px
    }

    .single-giftcard-tile span.giftcard-discount+.btnxxxxxxx {
      margin-top: 0 !important
    }
    ...
    button.btnxxxxxxx-editor-modal-close {
      background: #fff;
    ...
    button.btnxxxxxxx-editor-modal-close>span {
      display: block;
      font-size: 10px;
      text-transform: uppercase
    }
    ...
    button.btnxxxxxxx-editor-modal-close:hover {
    ...
    .editor .tool-pane .tool-content .dropdown-menu li .btnxxxxxxx {
      border: none !important;
      border-radius: 0 !important
    }

    .editor .tool-pane .tool-content .dropdown-menu li .btnxxxxxxx.active {
      box-shadow: none
    }
    ...
    .editor.editor-orientation-landscape .action.btnxxxxxxx-container {
      position: absolute
    }
    ...
    .tool-content-cutline .btnxxxxxxx-extra-new-outline {
    ...
    .confirm-modal.title-design .confirm-modal-inner .confirm-modal-content .actions .p-l-0:first-child .btnxxxxxxx-confirm {
      width: 150px
    }

    .confirm-modal.title-design .confirm-modal-inner .confirm-modal-content .actions .p-l-0 .btnxxxxxxx-warning {
      background: none;
      border: none;
      color: red
    }

    .confirm-modal.title-design .confirm-modal-inner .confirm-modal-content .actions .p-l-0 .btnxxxxxxx-warning:hover {
      background: none;
      color: #000
    }
    ...
    div.editor .editor-header .btnxxxxxxx {
      transition: none
    }
    ...
    div.editor>.btnxxxxxxx-save-sticker {
      bottom: 15px;
      display: none;
      position: absolute;
      right: 265px;
    ...
    div.editor-orientation-portrait .editor-header .btnxxxxxxx-home {
      color: #fff;
      font-size: 12px;
      font-weight: 700;
      opacity: 1;
    ...
    div.editor-orientation-portrait .editor-header .btnxxxxxxx-save {
      background: transparent
    }

    div.editor-orientation-portrait .editor-header .btnxxxxxxx-save .btnxxxxxxx-success {
      background: transparent;
      border: 0;
      color: #ffdb00;
      font-size: 12px;
    ...
    div.editor-orientation-portrait.sheet.zoomed .btnxxxxxxx-home,
    div.editor-orientation-portrait.sheet.zoomed .btnxxxxxxx-save,
    div.editor-orientation-portrait.sheet.zoomed .btnxxxxxxx-save-case,
    ...
    div.editor-orientation-portrait.sheet.zoomed .btnxxxxxxx-save-sticker {
      display: flex
    }

    div.editor-orientation-portrait.sheet.zoomed .btnxxxxxxx-save-sticker.hidden-portrait {
      display: none
    }

    div.editor-orientation-portrait.sheet.zoomed .btnxxxxxxx-save-sticker .btnxxxxxxx {
      background: transparent;
      border: 0;
      color: #4990e2;
      font-weight: 700;
    ...
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done {
      background-color: #ffdb00;
      border-color: #ffdb00;
      color: #040404
    }

    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done:focus {
      background-color: #ccaf00;
      border-color: #806e00;
      color: #040404;
    ...
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done.dropdown-toggle,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done.dropdown-toggle,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done.dropdown-toggle,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done.dropdown-toggle,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done.dropdown-toggle,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done.dropdown-toggle,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done.dropdown-toggle,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done.dropdown-toggle,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done.dropdown-toggle,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done.dropdown-toggle,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done.dropdown-toggle,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done.dropdown-toggle,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done.dropdown-toggle,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done.dropdown-toggle,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done.dropdown-toggle,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done.active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done:active,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done:hover {
      background-color: #ccaf00;
      border-color: #c2a600;
      color: #040404
    }

    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done.dropdown-toggle:hover,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done.dropdown-toggle:hover,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done.dropdown-toggle:hover,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done.dropdown-toggle:hover,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done.dropdown-toggle:hover,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done.dropdown-toggle:hover,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done.dropdown-toggle:hover,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done.dropdown-toggle:hover,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done.dropdown-toggle:hover,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done.dropdown-toggle:hover,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done.dropdown-toggle:hover,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done.dropdown-toggle:hover,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done.dropdown-toggle:hover,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done.dropdown-toggle:hover,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done.dropdown-toggle.focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done.dropdown-toggle:focus,
    .open>div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done.dropdown-toggle:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done:active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done:active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done:active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done:active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done:active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done:active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done:active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done:active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done:active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done:active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done:active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done:active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done:active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done:active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done.active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done.active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done.active:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done:active.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done:active:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done:active:hover {
      background-color: #a89100;
    ...
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done[disabled]:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done[disabled]:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done[disabled]:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done[disabled]:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done[disabled]:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done[disabled]:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done[disabled]:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done[disabled]:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done[disabled]:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done[disabled]:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done[disabled]:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done[disabled]:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done[disabled]:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done[disabled]:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done.disabled.focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done.disabled:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done.disabled:hover,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done[disabled].focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done[disabled]:focus,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done[disabled]:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done:hover,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done.focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done:focus,
    fieldset[disabled] div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done:hover {
      background-color: #ffdb00;
      border-color: #ffdb00
    }

    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col .btnxxxxxxx-done .badge,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-1 .btnxxxxxxx-done .badge,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-10 .btnxxxxxxx-done .badge,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-11 .btnxxxxxxx-done .badge,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-12 .btnxxxxxxx-done .badge,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2 .btnxxxxxxx-done .badge,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-2-9 .btnxxxxxxx-done .badge,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-3 .btnxxxxxxx-done .badge,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-4 .btnxxxxxxx-done .badge,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-5 .btnxxxxxxx-done .badge,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-6 .btnxxxxxxx-done .badge,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-7 .btnxxxxxxx-done .badge,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-8 .btnxxxxxxx-done .badge,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .f-col-9 .btnxxxxxxx-done .badge,
    div.editor-orientation-portrait .tool-pane.state-tool-open .footer .panel.panel-confirm .sp-hue .btnxxxxxxx-done .badge {
      background-color: #040404;
      color: #ffdb00
    }
    ...
    div.editor-orientation-portrait .tool-pane.state-tool-open[data-tool=upload] .footer .panel.panel-confirm .btnxxxxxxx {
      display: none
    }
    ...
    div.editor-orientation-portrait .tool-pane .tool-material-preset .btnxxxxxxx-group-justified button {
      border-radius: 20px;
      font-size: 11px;
      width: 100%
    }
    ...
    div.editor-orientation-portrait .tool-backside-print.appended .btnxxxxxxx-group {
      width: 80vw
    }
    ...
    div.editor-orientation-portrait .tool-backside-print-remove .btnxxxxxxx.btnxxxxxxx-remove {
      border-radius: 32px;
      font-size: 12px;
      outline: none;
      padding: 10px 20px
    ...
    div.editor-orientation-landscape.sheet.zoomed>.btnxxxxxxx-save-sticker {
      display: block
    }
    ...
    div.editor-orientation-landscape>.btnxxxxxxx-save-sticker {
      right: 425px
    }
    ...
    .tool-backside-print.appended .btnxxxxxxx-group {
      border-radius: 32px;
    ...
    .tool-backside-print.appended .btnxxxxxxx-group .btnxxxxxxx-primary {
      background-color: #fff;
      -webkit-box-shadow: none;
      box-shadow: none
    }

    .tool-backside-print .btnxxxxxxx-group {
      display: flex;
      width: 100%
    }

    .tool-backside-print .btnxxxxxxx-group .btnxxxxxxx {
      z-index: 99
    }

    .tool-backside-print .btnxxxxxxx-group .btnxxxxxxx-primary {
      background-color: #e8e8e8;
      border: none;
      flex: 1
    }

    .tool-backside-print .btnxxxxxxx-group .btnxxxxxxx-primary.active {
      background-color: #ffdb00
    }
    ...
    .tool-backside-print-remove #backside-print-remove-button.btnxxxxxxx.btnxxxxxxx-remove {
      border-radius: 32px;
      font-size: 12px;
      outline: none;
      padding: 10px 20px
    ...
    .tool-backside-print-remove.disabled .btnxxxxxxx.btnxxxxxxx-remove {
      background-color: #ccc
    }

    .btnxxxxxxx.btnxxxxxxx-remove {
      background-color: #da5246;
      border-radius: 0;
      color: #fff;
      font-size: 11px;
    ...
    .hidden-portrait .btnxxxxxxx.btnxxxxxxx-remove {
      font-size: 13px;
      line-height: 13px
    }

    .btnxxxxxxx.btnxxxxxxx-remove .desc {
      font-family: Helvetica, Arial, sans-serif;
      font-size: 9px;
      font-weight: 400;
    ...
    .sticker-packs-start-wrapper .sticker-packs-start .sticker-pack-card .sticker-pack-details .sticker-pack-buttons .btnxxxxxxx {
      width: 100%
    }
    ...
    .sticker-packs-start-wrapper .sticker-packs-start .sticker-pack-card .sticker-pack-details .sticker-pack-buttons .sticker-pack-view .btnxxxxxxx {
      background-color: transparent;
      border-color: transparent;
      color: #ffdb00
    }
    ...
    .sticker-packs-start-wrapper .sticker-packs-start .sticker-pack-card .sticker-pack-details .sticker-pack-buttons .sticker-pack-add-to-cart .btnxxxxxxx {
...
<style>
    div.header-design-select {
        padding: 50px;
        background-color: black;
        color: white;
        margin-bottom: 20px;
    }
    div.header-design-select h1 {
        color: white;
    }
...
<script src="<?php echo plugins_url('index.js?name', __FILE__); ?>"></script>