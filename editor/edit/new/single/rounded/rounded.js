var svgCon = document.getElementById("svg_1647249440_partGroup");
...
$(document).ready(function() {
    ...
    $('#btnSave, .save-mobile').on('click', function(){
        ...
        svgContainer += document.getElementById("svg_1647249440PartBackground").outerHTML + document.getElementById("svg_1647249440_partGroup").outerHTML +'</svg>';
