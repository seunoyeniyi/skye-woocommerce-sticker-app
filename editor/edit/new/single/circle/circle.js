var svgCon = document.getElementById("svg_1647249674_partGroup");
...
$(document).ready(function() {
    ...
    // var tjson = documnt.getElementById("textJSON").innerHTML;
    // document.getElementById("textJSON").innerHTML = tjson.replace("\"width\":51", "\"width\":"+document.getElementById("getWidth").value * 1);
    ...
    $('#btnSave, .save-mobile').on('click', function(){
        ...
        svgContainer += document.getElementById("svg_1647249674PartBackground").outerHTML + document.getElementById("svg_1647249674_partGroup").outerHTML +'</svg>';
