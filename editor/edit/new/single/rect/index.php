...
<head>
    ...
    <!-- <link rel="canonical" href="https://stickerapp.com/editor/edit/new/single/rect/0/300/51/25/glossy_coated"> -->
    ...
    <style type="text/css" media="all">
        ...
        *,
        ...
        .save-mobile[disabled].focus,
        .save-mobile[disabled]:focus,
        .save-mobile[disabled]:hover fieldset[disabled] .btn-buy.focus,
    ...
    <!-- <script src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/939789830/?random=1647248529192&amp;cv=9&amp;fst=1647248529192&amp;num=1&amp;bg=ffffff&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;u_h=768&amp;u_w=1366&amp;u_ah=728&amp;u_aw=1366&amp;u_cd=24&amp;u_his=15&amp;u_tz=60&amp;u_java=false&amp;u_nplug=0&amp;u_nmime=0&amp;gtm=2wg370&amp;sendb=1&amp;ig=0&amp;frm=0&amp;url=https%3A%2F%2Fstickerapp.com%2Feditor%2Fedit%2Fnew%2Fsingle%2Frect%2F0%2F300%2F51%2F25%2Fglossy_coated&amp;tiba=Custom%20stickers%20-%20StickerApp&amp;hn=www.google.com&amp;async=1&amp;rfmt=3&amp;fmt=4"></script> -->
    <script src="https://bat.bing.com/p/action/26345997.js" type="text/javascript" async="" data-ueto="ueto_ced19e29ed"></script>
    <?php wp_head(); ?>
...
<body class="editor single">
    ...
    <div class="main-wrapper">
            ...
            <div class="navbar stickerapp-nav hidden" style="display:none;" role="navigation">
                ...
                <div class="f-row nav-row f-align-items-center hidden-xs hidden-sm">
                    <ul class="nav navbar-nav navbar-left primary-nav f-row f-space-around ">
                        <li>
                            <a href="/customize-sticker">Custom stickers</a>
                        </li>
                    ...
                    <ul class="nav navbar-nav navbar-right  f-row f-space-around">
                        <li>
                            <a href="/customize-sticker/popular">Sticker library</a>
                        </li>
                        <li>
            ...
            <div class="editor preview-on editor-body-page single editor-ask-before-exit has-size-selector has-quantity-selector-enabled has-price-shown has-no-parts-selector has-material-selector has-title has-note-enabled editor-orientation-landscape editor-size-lg zoomed state-tool-open" data-size="auto" id="editor-1" style="top:1px;">
                <textarea class="nodisplay">
                {
                        ...
                        "parts": [
                            ...
                            {
                                "part_id": "svg_1647248524_backprint",
                ...
                <div class="editor-header f-row f-wrap-no">
                        ...
                        <a class="f-col btn btn-home cta hidden-landscape" href="/customize-sticker">
                            cancel </a>
                    <div class="f-col-9 hidden-portrait justify-content-between">
                        <h4 class="text-ellipsis modal-title h4">Custom sticker</h4>
                    ...
                    <div class="f-col-6 price text-center hidden-landscape">
                        <div class="amount summary-total price animated fadeIn">
                            $<?php echo $_GET['price']; ?>
                        </div>
		...
		C45.5,73.4,45.1,73.8,44.5,73.8z"></path>
                        ...
                        <div class="f-col-0 cta tool hidden-landscape tool-material-preset nodisplay" data-tool-content=".tool-content-material-preset" data-placement="auto top" style="border-right:0; display: none;" data-original-title="" title="">
                            <div class="content">
                                <label class="control-label">Material</label>
                        ...
                        <div class="f-row f-grid tool tool-size">
                            <div class="f-col">
                                <div class="content input">
                                    <label class="control-label" for="2305857809550462">
                                        Width <small>"</small>
                                    </label>
                                    <input type="number" class="summary-width" step="1" min="1" max="48" data-title="Enter value between $1 and $2" data-toggle="tooltip" data-placement="left" data-trigger="manual" data-container="#editor-1" data-original-title="" title="" id="2305857809550462" old="2">
                                </div>
                            </div>

                            <div class="f-col">
                                <div class="content input">
                                    <label class="control-label" for="42001246403366695">
                                        Height <small>"</small>
                                    </label>
                                    <input type="number" class="summary-height" step="1" min="1" max="48" data-title="Enter value between $1 and $2" data-toggle="tooltip" data-placement="left" data-trigger="manual" data-container="#editor-1" data-original-title="" title="" id="42001246403366695" old="1">
                                </div>
                            </div>

                            <div class="f-col cta tool tool-quantity " data-tool-content=".tool-content-quantity">
                                <div class="content input">
                                    <label class="control-label" for="4391618343689813">Quantity</label>
                                    <input value="<?php echo $_GET["quantity"];  ?>" type="number" class="summary-quantity hidden" min="1" step="1" data-title="Lowest value is $1" data-toggle="tooltip" data-placement="left" data-trigger="manual" data-original-title="" title="" old="<?php echo $_GET["quantity"];  ?>" id="4391618343689813">
                                    <input style="background: white;" value="<?php echo $_GET["quantity"];  ?>" type="text" class="" min="<?php echo $_GET["quantity"];  ?>" step="1" data-title="Lowest value is $1" data-toggle="tooltip" data-placement="left" data-trigger="manual" data-original-title="" title="" old="<?php echo $_GET["quantity"];  ?>" id="4391618343689813" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tool-content tool-content-quantity hidden">
                            <div class="tool-content-header">
                                <div class="tool-content-title f-row f-grid">
                                    <div class="f-col">
                                        <div class="content input">
                                            <label class="text-ellipsis tool-content-title control-label" for="20575192904147893">Custom quantity</label>
                                            <input value="<?php echo $_GET["quantity"];  ?>" type="number" class="summary-quantity" min="1" step="1" data-title="Lowest value is $1" data-toggle="tooltip" data-placement="left" data-trigger="manual" data-original-title="" title="" id="20575192904147893">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tool-content-body">
                                ...
                                <div class="f-row f-row-as-li cta list-item" data-quantity="300">
                                    ...
                                    <div class="f-col-2-9">
                                        <div class="price-formatted">$<?php echo $_GET['price']; ?></div>
                                    </div>
                                    <div class="f-col">
                                        <div class="save hidden">
                                            <div class="price-tag sm">
...
letter-spacing: .5px;box-sizing: border-box;">$<?php echo $_GET["price"];  ?></div>
		...
		C45.5,73.4,45.1,73.8,44.5,73.8z"></path>
                ...
                <div class="editor-container" style="padding-bottom: 0px; bottom: 0px;" id="editor-1-container"><svg id="editor-1-svgroot" viewBox="-14.614424705505371 -8.718352317810059 173.79600429534912 88.30295467376709" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" stickit="http://www.stickerapp.se" class="no-text-select" height="100%" width="100%">
                        <defs id="defsLayer" transform="matrix(1, 0, 0, 1, 0, 0)">
                            ...
                            <clipPath id="09358942139045735" transform="matrix(1, 0, 0, 1, 0, 0)">
                                <path d="M0,0C0,0,144.56715,0,144.56715,0C144.56715,0,144.56715,70.86625,144.56715,70.86625C144.56715,70.86625,0,70.86625,0,70.86625C0,70.86625,0,0,0,0" id="09358942139045735_path" transform="matrix(1, 0, 0, 1, 0, 0)"></path>
                            </clipPath>
                            <clipPath id="editorClip_svg_1647248524" transform="matrix(1, 0, 0, 1, 0, 0)">
                                <path d="M0,0C0,0,144.56715,0,144.56715,0C144.56715,0,144.56715,70.86625,144.56715,70.86625C144.56715,70.86625,0,70.86625,0,70.86625C0,70.86625,0,0,0,0" id="editorClip_svg_1647248524_path" transform="matrix(1, 0, 0, 1, 0, 0)"></path>
                            </clipPath>
                            <clipPath id="042328415260728314" transform="matrix(1, 0, 0, 1, 0, 0)">
                                <path d="" id="042328415260728314_path" transform="matrix(1, 0, 0, 1, 0, 0)"></path>
                            </clipPath>
                            <clipPath id="editorClip_svg_1647248524_backprint" transform="matrix(1, 0, 0, 1, 0, 0)">
                                <path d="" id="editorClip_svg_1647248524_backprint_path" transform="matrix(1, 0, 0, 1, 0, 0)"></path>
                            </clipPath>
                        </defs>
                        ...
                        <g id="svg_1647248524" style="visibility: visible;" clip-path="none" transform="matrix(1, 0, 0, 1, 0, 0)">
                            <path d="M0,0C0,0,144.56715,0,144.56715,0C144.56715,0,144.56715,70.86625,144.56715,70.86625C144.56715,70.86625,0,70.86625,0,70.86625C0,70.86625,0,0,0,0" fill="#FFFFFF" stroke="#A0A0A0" id="svg_1647248524PartBackground" transform="matrix(1, 0, 0, 1, 0, 0)" stroke-width="0.38113159045838474" filter="url(#drop_shadow)"></path>
                            <g id="svg_1647248524_partGroup" transform="matrix(1, 0, 0, 1, 0, 0)" clip-path="url(#09358942139045735)"></g>
                        </g>
                        <g id="svg_1647248524_backprint" style="visibility: visible; display: none;" clip-path="url(#editorClip_svg_1647248524_backprint)" transform="matrix(1, 0, 0, 1, 0, 0)">
                            <path d="" fill="#FFFFFF" stroke="none" id="svg_1647248524_backprintPartBackground" transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#drop_shadow)"></path>
                            <g id="svg_1647248524_backprint_partGroup" transform="matrix(1, 0, 0, 1, 0, 0)"></g>
                        </g>
                        <g id="shadowLayer" transform="matrix(1, 0, 0, 1, 0, 0)">
                            <path d="M -24.614425659179688 -85.6667251586914 L -24.614425659179688 156.53298950195312 L 169.18157958984375 156.53298950195312 L 169.18157958984375 -85.6667251586914 z M0,0C0,0,144.56715,0,144.56715,0C144.56715,0,144.56715,70.86625,144.56715,70.86625C144.56715,70.86625,0,70.86625,0,70.86625C0,70.86625,0,0,0,0" id="03449843295385383" fill-rule="evenodd" class="svgShadowOverlay" transform="matrix(1, 0, 0, 1, 0, 0)" style="display: none;"></path>
                        </g>
                        <g id="partPathLayer" transform="matrix(1, 0, 0, 1, 0, 0)">
                            <path d="M 0 0 L 0 70.86624908447266 L 144.56715393066406 70.86624908447266 L 144.56715393066406 0 z" id="041663630211493896" class="svgSheetPath single" transform="matrix(1, 0, 0, 1, 0, 0)"></path>
                            <path d="M0,0C0,0,144.56715,0,144.56715,0C144.56715,0,144.56715,70.86625,144.56715,70.86625C144.56715,70.86625,0,70.86625,0,70.86625C0,70.86625,0,0,0,0" id="09007266923538086" class="svgPartPath dropShadow" transform="matrix(1, 0, 0, 1, 0, 0) matrix(1, 0, 0, 1, 0, 0)" style="visibility: hidden; stroke-width: 0.381132px; stroke-dasharray: none;"></path>
                            <path d="" id="03759740697122502" class="svgPartPath dropShadow" transform="matrix(1, 0, 0, 1, 0, 0) matrix(1, 0, 0, 1, 0, 0)" style="visibility: visible; stroke-width: 0.381132px; display: none;"></path>
                        </g>
                        <g id="preTopLayer"></g>
                        <g id="infoLayer" transform="matrix(1, 0, 0, 1, 0, 0)"><text x="72.78357696533203" y="80.39453884593227" fill="function fill() {
    [native code]
}" class="svgPartSizeText" id="05350791140664074" space="preserve" font-size="5.7169738568757715" text-anchor="middle" transform="matrix(1, 0, 0, 1, 0, 0)">
    ...
    [native code]
}" class="svgPartSizeText" id="05350791140664074" transform="matrix(0, 1, -1, 0, 186.217, -114.351)" space="preserve" font-size="5.7169738568757715" text-anchor="middle">
                                <tspan x="150.28412778753983" y="35.93312454223633">1"</tspan>
                            </text></g>
                        <g id="selectLayer"></g>
                    </svg></div>
                <input type="file" id="file1" name="files[]" class="fileupload hidden" multiple="" accept="image/jpeg, image/png, image/gif, application/pdf, application/postscript, image/svg+xml, image/bmp, image/x-windows-bmp, application/psd, application/x-photoshop, image/photoshop, image/psd, image/x-photoshop, image/x-psd, .psd, image/tiff">
...
<script src="https://d6ce0no7ktiq.cloudfront.net/build/5.7.89/editor.js"></script> -->
    ...
    <script src="<?php echo plugins_url('rect.js?name', __FILE__); ?>"></script>
    <!-- end SCRIPTS -->
    ...
    <div style="width:0px; height:0px; display:none; visibility:hidden;" id="batBeacon33390238852"><img style="width:0px; height:0px; display:none; visibility:hidden;" id="batBeacon207420652070" alt="" src="https://bat.bing.com/action/0?ti=26345997&amp;tm=gtm002&amp;Ver=2&amp;mid=d715eb67-2382-4de6-9824-ddc22fec9f86&amp;sid=ea3935a0a24111ec9e39c32694612fed&amp;vid=dfe613e0a0af11ec8488b53d42d23a65&amp;vids=0&amp;pi=0&amp;lg=en-US&amp;sw=1366&amp;sh=768&amp;sc=24&amp;tl=Custom%20stickers%20-%20StickerApp&amp;p=https%3A%2F%2Fstickerapp.com%2Feditor%2Fedit%2Fnew%2Fsingle%2Frect%2F0%2F300%2F51%2F25%2Fglossy_coated&amp;r=&amp;lt=4098&amp;evt=pageLoad&amp;msclkid=N&amp;sv=1&amp;rn=550482" width="0" height="0"></div>
